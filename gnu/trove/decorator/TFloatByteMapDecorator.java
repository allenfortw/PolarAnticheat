...
/*     */     } 
/* 112 */     byte retval = this._map.put(k, v);
...
/* 192 */     return new AbstractSet<Map.Entry<Float, Byte>>() {
/*     */         public int size() {
/* 194 */           return TFloatByteMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TFloatByteMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TFloatByteMapDecorator.this.containsKey(k) && TFloatByteMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Float, Byte>>() {
/* 214 */               private final TFloatByteIterator it = TFloatByteMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Float, Byte> next() {
/* 217 */                 this.it.advance();
/* 218 */                 float ik = this.it.key();
/* 219 */                 final Float key = (ik == TFloatByteMapDecorator.this._map.getNoEntryKey()) ? null : TFloatByteMapDecorator.this.wrapKey(ik);
/* 220 */                 byte iv = this.it.value();
/* 221 */                 final Byte v = (iv == TFloatByteMapDecorator.this._map.getNoEntryValue()) ? null : TFloatByteMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Float, Byte>() {
/* 223 */                     private Byte val = v;
/*     */                     
...
/* 244 */                       this.val = value;
/* 245 */                       return TFloatByteMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TFloatByteMapDecorator.this._map.remove(TFloatByteMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TFloatByteMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 293 */     return (val instanceof Byte && this._map.containsValue(unwrapValue(val)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Float, ? extends Byte>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Float, ? extends Byte> e = it.next();
...
/* 386 */     return ((Byte)value).byteValue();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 398 */     this._map = (TFloatByteMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TFloatByteMapDecorator.class
