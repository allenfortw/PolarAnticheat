...
/* 192 */     return new AbstractSet<Map.Entry<Character, Long>>() {
/*     */         public int size() {
/* 194 */           return TCharLongMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TCharLongMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TCharLongMapDecorator.this.containsKey(k) && TCharLongMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Character, Long>>() {
/* 214 */               private final TCharLongIterator it = TCharLongMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Character, Long> next() {
/* 217 */                 this.it.advance();
/* 218 */                 char ik = this.it.key();
/* 219 */                 final Character key = (ik == TCharLongMapDecorator.this._map.getNoEntryKey()) ? null : TCharLongMapDecorator.this.wrapKey(ik);
/* 220 */                 long iv = this.it.value();
/* 221 */                 final Long v = (iv == TCharLongMapDecorator.this._map.getNoEntryValue()) ? null : TCharLongMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Character, Long>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TCharLongMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TCharLongMapDecorator.this._map.remove(TCharLongMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TCharLongMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Character, ? extends Long>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Character, ? extends Long> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TCharLongMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TCharLongMapDecorator.class
