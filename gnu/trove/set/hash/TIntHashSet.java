...
/*     */   
/*     */   public int[] toArray() {
/* 161 */     return toArray(new int[this._size]);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 168 */       dest = new int[this._size];
/*     */     }
/*     */     
/* 171 */     int[] set = this._set;
...
/* 215 */       if (element instanceof Integer) {
/* 216 */         int c = ((Integer)element).intValue();
/* 217 */         if (!contains(c))
/* 218 */           return false; 
/*     */         continue;
/*     */       } 
...
/* 231 */     TIntIterator iter = collection.iterator();
/* 232 */     while (iter.hasNext()) {
/* 233 */       int element = iter.next();
...
/* 256 */     for (Integer element : collection) {
/* 257 */       int e = element.intValue();
/* 258 */       if (add(e)) {
/* 259 */         changed = true;
/*     */       }
/*     */     } 
...
/* 269 */     TIntIterator iter = collection.iterator();
/* 270 */     while (iter.hasNext()) {
/* 271 */       int element = iter.next();
/* 272 */       if (add(element)) {
/* 273 */         changed = true;
/*     */       }
/*     */     } 
...
/* 296 */     TIntIterator iter = iterator();
/* 297 */     while (iter.hasNext()) {
/* 298 */       if (!collection.contains(Integer.valueOf(iter.next()))) {
/* 299 */         iter.remove();
/* 300 */         modified = true;
/*     */       } 
/*     */     } 
...
/* 313 */     TIntIterator iter = iterator();
...
/* 348 */       if (element instanceof Integer) {
/* 349 */         int c = ((Integer)element).intValue();
/* 350 */         if (remove(c)) {
/* 351 */           changed = true;
/*     */         }
/*     */       } 
...
/* 362 */     TIntIterator iter = collection.iterator();
/* 363 */     while (iter.hasNext()) {
/* 364 */       int element = iter.next();
...
/*     */     
/* 402 */     int[] oldSet = this._set;
/* 403 */     byte[] oldStates = this._states;
/*     */     
/* 405 */     this._set = new int[newCapacity];
...
/* 419 */     if (!(other instanceof TIntSet)) {
/* 420 */       return false;
/*     */     }
/* 422 */     TIntSet that = (TIntSet)other;
...
/*     */ 
/*     */     
/* 501 */     out.writeInt(this.no_entry_value);
/*     */ 
/*     */     
/* 504 */     for (int i = this._states.length; i-- > 0;) {
/* 505 */       if (this._states[i] == 1) {
/* 506 */         out.writeInt(this._set[i]);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/*     */ 
/*     */       
/* 530 */       this.no_entry_value = in.readInt();
/*     */       
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\set\hash\TIntHashSet.class
