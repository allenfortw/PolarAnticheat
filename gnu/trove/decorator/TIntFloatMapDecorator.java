...
/* 192 */     return new AbstractSet<Map.Entry<Integer, Float>>() {
/*     */         public int size() {
/* 194 */           return TIntFloatMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TIntFloatMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TIntFloatMapDecorator.this.containsKey(k) && TIntFloatMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Integer, Float>>() {
/* 214 */               private final TIntFloatIterator it = TIntFloatMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Integer, Float> next() {
/* 217 */                 this.it.advance();
/* 218 */                 int ik = this.it.key();
/* 219 */                 final Integer key = (ik == TIntFloatMapDecorator.this._map.getNoEntryKey()) ? null : TIntFloatMapDecorator.this.wrapKey(ik);
/* 220 */                 float iv = this.it.value();
/* 221 */                 final Float v = (iv == TIntFloatMapDecorator.this._map.getNoEntryValue()) ? null : TIntFloatMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Integer, Float>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TIntFloatMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TIntFloatMapDecorator.this._map.remove(TIntFloatMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TIntFloatMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Integer, ? extends Float>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Integer, ? extends Float> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TIntFloatMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TIntFloatMapDecorator.class
