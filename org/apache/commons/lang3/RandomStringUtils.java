...
/* 323 */     return random(count, start, end, letters, numbers, chars, RANDOM);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 364 */       return ""; 
/* 365 */     if (count < 0) {
/* 366 */       throw new IllegalArgumentException("Requested random string length " + count + " is less than 0.");
/*     */     }
/* 368 */     if (chars != null && chars.length == 0) {
/* 369 */       throw new IllegalArgumentException("The chars array must not be empty");
/*     */     }
/*     */     
/* 372 */     if (start == 0 && end == 0) {
/* 373 */       if (chars != null) {
/* 374 */         end = chars.length;
/* 375 */       } else if (!letters && !numbers) {
/* 376 */         end = 1114111;
/*     */       } else {
/* 378 */         end = 123;
/* 379 */         start = 32;
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\org\apache\commons\lang3\RandomStringUtils.class
