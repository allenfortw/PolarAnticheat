...
/* 192 */     return new AbstractSet<Map.Entry<Long, Character>>() {
/*     */         public int size() {
/* 194 */           return TLongCharMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TLongCharMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TLongCharMapDecorator.this.containsKey(k) && TLongCharMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Long, Character>>() {
/* 214 */               private final TLongCharIterator it = TLongCharMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Long, Character> next() {
/* 217 */                 this.it.advance();
/* 218 */                 long ik = this.it.key();
/* 219 */                 final Long key = (ik == TLongCharMapDecorator.this._map.getNoEntryKey()) ? null : TLongCharMapDecorator.this.wrapKey(ik);
/* 220 */                 char iv = this.it.value();
/* 221 */                 final Character v = (iv == TLongCharMapDecorator.this._map.getNoEntryValue()) ? null : TLongCharMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Long, Character>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TLongCharMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TLongCharMapDecorator.this._map.remove(TLongCharMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TLongCharMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Long, ? extends Character>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Long, ? extends Character> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TLongCharMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TLongCharMapDecorator.class
