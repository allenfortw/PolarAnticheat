...
/* 192 */     return new AbstractSet<Map.Entry<Character, Float>>() {
/*     */         public int size() {
/* 194 */           return TCharFloatMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TCharFloatMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TCharFloatMapDecorator.this.containsKey(k) && TCharFloatMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Character, Float>>() {
/* 214 */               private final TCharFloatIterator it = TCharFloatMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Character, Float> next() {
/* 217 */                 this.it.advance();
/* 218 */                 char ik = this.it.key();
/* 219 */                 final Character key = (ik == TCharFloatMapDecorator.this._map.getNoEntryKey()) ? null : TCharFloatMapDecorator.this.wrapKey(ik);
/* 220 */                 float iv = this.it.value();
/* 221 */                 final Float v = (iv == TCharFloatMapDecorator.this._map.getNoEntryValue()) ? null : TCharFloatMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Character, Float>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TCharFloatMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TCharFloatMapDecorator.this._map.remove(TCharFloatMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TCharFloatMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Character, ? extends Float>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Character, ? extends Float> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TCharFloatMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TCharFloatMapDecorator.class
