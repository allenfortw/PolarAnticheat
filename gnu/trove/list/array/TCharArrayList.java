...
/*   92 */     this._data = new char[capacity];
/*   93 */     this._pos = 0;
...
/*  163 */     return new TCharArrayList(values, no_entry_value, true)
/*      */       {
/*      */ 
/*      */         
...
/*      */     }
/*      */     
/*  306 */     char prev_val = this._data[offset];
...
/*      */     }
/*  317 */     char old = this._data[offset];
...
/*  414 */     return new TCharArrayIterator(0);
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  421 */       if (element instanceof Character) {
/*  422 */         char c = ((Character)element).charValue();
/*  423 */         if (!contains(c))
/*  424 */           return false; 
/*      */         continue;
/*      */       } 
...
/*  438 */       return true;
/*      */     }
/*  440 */     TCharIterator iter = collection.iterator();
/*  441 */     while (iter.hasNext()) {
/*  442 */       char element = iter.next();
...
/*  465 */     for (Character element : collection) {
/*  466 */       char e = element.charValue();
/*  467 */       if (add(e)) {
/*  468 */         changed = true;
/*      */       }
/*      */     } 
...
/*  478 */     TCharIterator iter = collection.iterator();
/*  479 */     while (iter.hasNext()) {
/*  480 */       char element = iter.next();
/*  481 */       if (add(element)) {
/*  482 */         changed = true;
/*      */       }
/*      */     } 
...
/*  505 */     TCharIterator iter = iterator();
/*  506 */     while (iter.hasNext()) {
/*  507 */       if (!collection.contains(Character.valueOf(iter.next()))) {
/*  508 */         iter.remove();
/*  509 */         modified = true;
/*      */       } 
/*      */     } 
...
/*  522 */     TCharIterator iter = iterator();
...
/*  553 */       if (element instanceof Character) {
/*  554 */         char c = ((Character)element).charValue();
/*  555 */         if (remove(c)) {
/*  556 */           changed = true;
/*      */         }
/*      */       } 
...
/*  571 */     TCharIterator iter = collection.iterator();
/*  572 */     while (iter.hasNext()) {
/*  573 */       char element = iter.next();
...
/*      */     }
/*  657 */     TCharArrayList list = new TCharArrayList(end - begin);
...
/*  723 */       return true;
/*      */     }
/*  725 */     if (!(other instanceof TCharList)) return false;
/*      */     
/*  727 */     if (other instanceof TCharArrayList) {
/*  728 */       TCharArrayList tCharArrayList = (TCharArrayList)other;
/*  729 */       if (tCharArrayList.size() != size()) return false;
/*      */       
/*  731 */       for (int j = this._pos; j-- > 0;) {
/*  732 */         if (this._data[j] != tCharArrayList._data[j]) {
/*  733 */           return false;
/*      */         }
/*      */       } 
/*  736 */       return true;
/*      */     } 
/*      */     
/*  739 */     TCharList that = (TCharList)other;
...
/*  841 */       char midVal = this._data[mid];
/*      */       
/*  843 */       if (midVal < value) {
...
/*  899 */     TCharArrayList list = new TCharArrayList();
...
/*  911 */     TCharArrayList list = new TCharArrayList();
...
/*      */     }
/*  926 */     char max = Character.MIN_VALUE;
...
/*      */     }
/*  941 */     char min = Character.MAX_VALUE;
...
/*      */   
/*      */   public char sum() {
/*  953 */     char sum = Character.MIN_VALUE;
/*  954 */     for (int i = 0; i < this._pos; i++) {
/*  955 */       sum = (char)(sum + this._data[i]);
/*      */     }
/*  957 */     return sum;
/*      */   }
/*      */ 
...
/* 1000 */       return (this.cursor < TCharArrayList.this.size());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public char next() {
/*      */       try {
/* 1007 */         char next = TCharArrayList.this.get(this.cursor);
...
/*      */       }
/*      */       try {
/* 1022 */         TCharArrayList.this.remove(this.lastRet, 1);
...
/*      */ 
/*      */     
/* 1062 */     this.no_entry_value = in.readChar();
/*      */ 
/*      */     
/* 1065 */     int len = in.readInt();
/* 1066 */     this._data = new char[len];
/* 1067 */     for (int i = 0; i < len; i++)
/* 1068 */       this._data[i] = in.readChar(); 
/*      */   }
/*      */ }


/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\list\array\TCharArrayList.class
