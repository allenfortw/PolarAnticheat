...
/*   92 */     this._data = new double[capacity];
/*   93 */     this._pos = 0;
...
/*  163 */     return new TDoubleArrayList(values, no_entry_value, true)
/*      */       {
/*      */ 
/*      */         
...
/*  191 */       double[] tmp = new double[newCap];
...
/*  215 */       double[] tmp = new double[size()];
...
/*      */     }
/*      */     
/*  306 */     double prev_val = this._data[offset];
...
/*      */     }
/*  317 */     double old = this._data[offset];
...
/*  414 */     return new TDoubleArrayIterator(0);
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  421 */       if (element instanceof Double) {
/*  422 */         double c = ((Double)element).doubleValue();
/*  423 */         if (!contains(c))
/*  424 */           return false; 
/*      */         continue;
/*      */       } 
...
/*  438 */       return true;
/*      */     }
/*  440 */     TDoubleIterator iter = collection.iterator();
/*  441 */     while (iter.hasNext()) {
/*  442 */       double element = iter.next();
...
/*  465 */     for (Double element : collection) {
/*  466 */       double e = element.doubleValue();
/*  467 */       if (add(e)) {
/*  468 */         changed = true;
/*      */       }
/*      */     } 
...
/*  478 */     TDoubleIterator iter = collection.iterator();
/*  479 */     while (iter.hasNext()) {
/*  480 */       double element = iter.next();
/*  481 */       if (add(element)) {
/*  482 */         changed = true;
/*      */       }
/*      */     } 
...
/*  505 */     TDoubleIterator iter = iterator();
/*  506 */     while (iter.hasNext()) {
/*  507 */       if (!collection.contains(Double.valueOf(iter.next()))) {
/*  508 */         iter.remove();
/*  509 */         modified = true;
/*      */       } 
/*      */     } 
...
/*  522 */     TDoubleIterator iter = iterator();
...
/*  553 */       if (element instanceof Double) {
/*  554 */         double c = ((Double)element).doubleValue();
/*  555 */         if (remove(c)) {
/*  556 */           changed = true;
/*      */         }
/*      */       } 
...
/*  571 */     TDoubleIterator iter = collection.iterator();
/*  572 */     while (iter.hasNext()) {
/*  573 */       double element = iter.next();
...
/*      */     }
/*  657 */     TDoubleArrayList list = new TDoubleArrayList(end - begin);
...
/*  723 */       return true;
/*      */     }
/*  725 */     if (!(other instanceof TDoubleList)) return false;
/*      */     
/*  727 */     if (other instanceof TDoubleArrayList) {
/*  728 */       TDoubleArrayList tDoubleArrayList = (TDoubleArrayList)other;
/*  729 */       if (tDoubleArrayList.size() != size()) return false;
/*      */       
/*  731 */       for (int j = this._pos; j-- > 0;) {
/*  732 */         if (this._data[j] != tDoubleArrayList._data[j]) {
/*  733 */           return false;
/*      */         }
/*      */       } 
/*  736 */       return true;
/*      */     } 
/*      */     
/*  739 */     TDoubleList that = (TDoubleList)other;
...
/*  841 */       double midVal = this._data[mid];
/*      */       
/*  843 */       if (midVal < value) {
...
/*  899 */     TDoubleArrayList list = new TDoubleArrayList();
...
/*  911 */     TDoubleArrayList list = new TDoubleArrayList();
...
/*      */     }
/*  926 */     double max = Double.NEGATIVE_INFINITY;
...
/*      */     }
/*  941 */     double min = Double.POSITIVE_INFINITY;
...
/* 1000 */       return (this.cursor < TDoubleArrayList.this.size());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double next() {
/*      */       try {
/* 1007 */         double next = TDoubleArrayList.this.get(this.cursor);
...
/*      */       }
/*      */       try {
/* 1022 */         TDoubleArrayList.this.remove(this.lastRet, 1);
...
/*      */ 
/*      */     
/* 1062 */     this.no_entry_value = in.readDouble();
/*      */ 
/*      */     
/* 1065 */     int len = in.readInt();
/* 1066 */     this._data = new double[len];
/* 1067 */     for (int i = 0; i < len; i++)
/* 1068 */       this._data[i] = in.readDouble(); 
/*      */   }
/*      */ }


/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\list\array\TDoubleArrayList.class
