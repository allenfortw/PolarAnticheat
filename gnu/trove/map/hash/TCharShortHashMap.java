...
/*  322 */       array = new char[size];
/*      */     }
/*      */     
/*  325 */     char[] keys = this._set;
...
/*  405 */     return new TCharShortHashIterator(this);
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  527 */       return new TCharShortHashMap.TCharShortKeyHashIterator((TPrimitiveHash)TCharShortHashMap.this);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public char getNoEntryValue() {
/*  533 */       return TCharShortHashMap.this.no_entry_key;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int size() {
/*  539 */       return TCharShortHashMap.this._size;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean isEmpty() {
/*  545 */       return (0 == TCharShortHashMap.this._size);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean contains(char entry) {
/*  551 */       return TCharShortHashMap.this.contains(entry);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public char[] toArray() {
/*  557 */       return TCharShortHashMap.this.keys();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public char[] toArray(char[] dest) {
/*  563 */       return TCharShortHashMap.this.keys(dest);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  579 */       return (TCharShortHashMap.this.no_entry_value != TCharShortHashMap.this.remove(entry));
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  586 */         if (element instanceof Character) {
/*  587 */           char ele = ((Character)element).charValue();
/*  588 */           if (!TCharShortHashMap.this.containsKey(ele))
/*  589 */             return false; 
/*      */           continue;
/*      */         } 
/*  592 */         return false;
...
/*  601 */       TCharIterator iter = collection.iterator();
/*  602 */       while (iter.hasNext()) {
/*  603 */         if (!TCharShortHashMap.this.containsKey(iter.next())) {
/*  604 */           return false;
/*      */         }
/*      */       } 
/*  607 */       return true;
...
/*  613 */       for (char element : array) {
/*  614 */         if (!TCharShortHashMap.this.contains(element)) {
/*  615 */           return false;
/*      */         }
/*      */       } 
/*  618 */       return true;
...
/*  656 */       TCharIterator iter = iterator();
/*  657 */       while (iter.hasNext()) {
/*  658 */         if (!collection.contains(Character.valueOf(iter.next()))) {
/*  659 */           iter.remove();
/*  660 */           modified = true;
/*      */         } 
/*      */       } 
...
/*  673 */       TCharIterator iter = iterator();
...
/*  688 */       char[] set = TCharShortHashMap.this._set;
/*  689 */       byte[] states = TCharShortHashMap.this._states;
/*      */       
/*  691 */       for (int i = set.length; i-- > 0;) {
/*  692 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  693 */           TCharShortHashMap.this.removeAt(i);
/*  694 */           changed = true;
/*      */         } 
/*      */       } 
/*  697 */       return changed;
...
/*  705 */         if (element instanceof Character) {
/*  706 */           char c = ((Character)element).charValue();
/*  707 */           if (remove(c)) {
/*  708 */             changed = true;
/*      */           }
/*      */         } 
...
/*  723 */       TCharIterator iter = collection.iterator();
/*  724 */       while (iter.hasNext()) {
/*  725 */         char element = iter.next();
...
/*      */     
/*      */     public void clear() {
/*  748 */       TCharShortHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean forEach(TCharProcedure procedure) {
/*  754 */       return TCharShortHashMap.this.forEachKey(procedure);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean equals(Object other) {
/*  760 */       if (!(other instanceof TCharSet)) {
/*  761 */         return false;
/*      */       }
/*  763 */       TCharSet that = (TCharSet)other;
/*  764 */       if (that.size() != size()) {
/*  765 */         return false;
/*      */       }
/*  767 */       for (int i = TCharShortHashMap.this._states.length; i-- > 0;) {
/*  768 */         if (TCharShortHashMap.this._states[i] == 1 && 
/*  769 */           !that.contains(TCharShortHashMap.this._set[i])) {
/*  770 */           return false;
/*      */         }
/*      */       } 
/*      */       
...
/*      */     public int hashCode() {
/*  780 */       int hashcode = 0;
/*  781 */       for (int i = TCharShortHashMap.this._states.length; i-- > 0;) {
/*  782 */         if (TCharShortHashMap.this._states[i] == 1) {
/*  783 */           hashcode += HashFunctions.hash(TCharShortHashMap.this._set[i]);
/*      */         }
/*      */       } 
/*  786 */       return hashcode;
/*      */     }
...
/*  793 */       TCharShortHashMap.this.forEachKey(new TCharProcedure()
/*      */           {
...
/*  819 */       return new TCharShortHashMap.TCharShortValueHashIterator((TPrimitiveHash)TCharShortHashMap.this);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short getNoEntryValue() {
/*  825 */       return TCharShortHashMap.this.no_entry_value;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int size() {
/*  831 */       return TCharShortHashMap.this._size;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean isEmpty() {
/*  837 */       return (0 == TCharShortHashMap.this._size);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean contains(short entry) {
/*  843 */       return TCharShortHashMap.this.containsValue(entry);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short[] toArray() {
/*  849 */       return TCharShortHashMap.this.values();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short[] toArray(short[] dest) {
/*  855 */       return TCharShortHashMap.this.values(dest);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  867 */       short[] values = TCharShortHashMap.this._values;
/*  868 */       byte[] states = TCharShortHashMap.this._states;
/*      */       
/*  870 */       for (int i = values.length; i-- > 0;) {
/*  871 */         if (states[i] != 0 && states[i] != 2 && entry == values[i]) {
/*  872 */           TCharShortHashMap.this.removeAt(i);
/*  873 */           return true;
/*      */         } 
/*      */       } 
/*  876 */       return false;
...
/*  884 */           if (!TCharShortHashMap.this.containsValue(ele))
/*  885 */             return false; 
/*      */           continue;
/*      */         } 
/*  888 */         return false;
...
/*  899 */         if (!TCharShortHashMap.this.containsValue(iter.next())) {
/*  900 */           return false;
/*      */         }
/*      */       } 
/*  903 */       return true;
...
/*  910 */         if (!TCharShortHashMap.this.containsValue(element)) {
/*  911 */           return false;
/*      */         }
/*      */       } 
/*  914 */       return true;
...
/*  972 */       short[] values = TCharShortHashMap.this._values;
/*  973 */       byte[] states = TCharShortHashMap.this._states;
/*      */       
/*  975 */       for (int i = values.length; i-- > 0;) {
/*  976 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  977 */           TCharShortHashMap.this.removeAt(i);
/*  978 */           changed = true;
/*      */         } 
/*      */       } 
/*  981 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1032 */       TCharShortHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean forEach(TShortProcedure procedure) {
/* 1038 */       return TCharShortHashMap.this.forEachValue(procedure);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1046 */       TCharShortHashMap.this.forEachValue(new TShortProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1080 */       return TCharShortHashMap.this._set[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1092 */         TCharShortHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/* 1118 */       return TCharShortHashMap.this._values[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1130 */         TCharShortHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/*      */     
/*      */     public char key() {
/* 1159 */       return TCharShortHashMap.this._set[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short value() {
/* 1164 */       return TCharShortHashMap.this._values[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short setValue(short val) {
/* 1169 */       short old = value();
/* 1170 */       TCharShortHashMap.this._values[this._index] = val;
/* 1171 */       return old;
/*      */     }
/*      */ 
/*      */     
...
/* 1182 */         TCharShortHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1195 */     if (!(other instanceof TCharShortMap)) {
/* 1196 */       return false;
/*      */     }
/* 1198 */     TCharShortMap that = (TCharShortMap)other;
...
/* 1246 */     forEachEntry(new TCharShortProcedure()
/*      */         {
...
/* 1277 */         out.writeChar(this._set[i]);
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\map\hash\TCharShortHashMap.class
