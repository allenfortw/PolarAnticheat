...
/*  85 */     return Integer.valueOf(this.value);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 196 */     this.value += operand.intValue();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 217 */     this.value -= operand.intValue();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 243 */     this.value += operand.intValue();
...
/* 271 */     int last = this.value;
/* 272 */     this.value += operand.intValue();
/* 273 */     return last;
/*     */   }
/*     */ 
/*     */ 
...
/* 339 */     if (obj instanceof MutableInt) {
/* 340 */       return (this.value == ((MutableInt)obj).intValue());
/*     */     }
/* 342 */     return false;
/*     */   }
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\org\apache\commons\lang3\mutable\MutableInt.class
