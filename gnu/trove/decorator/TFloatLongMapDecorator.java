...
/* 192 */     return new AbstractSet<Map.Entry<Float, Long>>() {
/*     */         public int size() {
/* 194 */           return TFloatLongMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TFloatLongMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TFloatLongMapDecorator.this.containsKey(k) && TFloatLongMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Float, Long>>() {
/* 214 */               private final TFloatLongIterator it = TFloatLongMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Float, Long> next() {
/* 217 */                 this.it.advance();
/* 218 */                 float ik = this.it.key();
/* 219 */                 final Float key = (ik == TFloatLongMapDecorator.this._map.getNoEntryKey()) ? null : TFloatLongMapDecorator.this.wrapKey(ik);
/* 220 */                 long iv = this.it.value();
/* 221 */                 final Long v = (iv == TFloatLongMapDecorator.this._map.getNoEntryValue()) ? null : TFloatLongMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Float, Long>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TFloatLongMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TFloatLongMapDecorator.this._map.remove(TFloatLongMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TFloatLongMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Float, ? extends Long>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Float, ? extends Long> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TFloatLongMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TFloatLongMapDecorator.class
