...
/* 192 */     return new AbstractSet<Map.Entry<Integer, Byte>>() {
/*     */         public int size() {
/* 194 */           return TIntByteMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TIntByteMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TIntByteMapDecorator.this.containsKey(k) && TIntByteMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Integer, Byte>>() {
/* 214 */               private final TIntByteIterator it = TIntByteMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Integer, Byte> next() {
/* 217 */                 this.it.advance();
/* 218 */                 int ik = this.it.key();
/* 219 */                 final Integer key = (ik == TIntByteMapDecorator.this._map.getNoEntryKey()) ? null : TIntByteMapDecorator.this.wrapKey(ik);
/* 220 */                 byte iv = this.it.value();
/* 221 */                 final Byte v = (iv == TIntByteMapDecorator.this._map.getNoEntryValue()) ? null : TIntByteMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Integer, Byte>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TIntByteMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TIntByteMapDecorator.this._map.remove(TIntByteMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TIntByteMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Integer, ? extends Byte>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Integer, ? extends Byte> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TIntByteMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TIntByteMapDecorator.class
