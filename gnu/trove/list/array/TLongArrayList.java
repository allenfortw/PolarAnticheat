...
/*   92 */     this._data = new long[capacity];
/*   93 */     this._pos = 0;
...
/*  163 */     return new TLongArrayList(values, no_entry_value, true)
/*      */       {
/*      */ 
/*      */         
...
/*      */     }
/*      */     
/*  306 */     long prev_val = this._data[offset];
...
/*      */     }
/*  317 */     long old = this._data[offset];
...
/*  414 */     return new TLongArrayIterator(0);
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  421 */       if (element instanceof Long) {
/*  422 */         long c = ((Long)element).longValue();
/*  423 */         if (!contains(c))
/*  424 */           return false; 
/*      */         continue;
/*      */       } 
...
/*  438 */       return true;
/*      */     }
/*  440 */     TLongIterator iter = collection.iterator();
/*  441 */     while (iter.hasNext()) {
/*  442 */       long element = iter.next();
...
/*  465 */     for (Long element : collection) {
/*  466 */       long e = element.longValue();
/*  467 */       if (add(e)) {
/*  468 */         changed = true;
/*      */       }
/*      */     } 
...
/*  478 */     TLongIterator iter = collection.iterator();
/*  479 */     while (iter.hasNext()) {
/*  480 */       long element = iter.next();
/*  481 */       if (add(element)) {
/*  482 */         changed = true;
/*      */       }
/*      */     } 
...
/*  505 */     TLongIterator iter = iterator();
/*  506 */     while (iter.hasNext()) {
/*  507 */       if (!collection.contains(Long.valueOf(iter.next()))) {
/*  508 */         iter.remove();
/*  509 */         modified = true;
/*      */       } 
/*      */     } 
...
/*  522 */     TLongIterator iter = iterator();
...
/*  553 */       if (element instanceof Long) {
/*  554 */         long c = ((Long)element).longValue();
/*  555 */         if (remove(c)) {
/*  556 */           changed = true;
/*      */         }
/*      */       } 
...
/*  571 */     TLongIterator iter = collection.iterator();
/*  572 */     while (iter.hasNext()) {
/*  573 */       long element = iter.next();
...
/*      */     }
/*  657 */     TLongArrayList list = new TLongArrayList(end - begin);
...
/*  723 */       return true;
/*      */     }
/*  725 */     if (!(other instanceof TLongList)) return false;
/*      */     
/*  727 */     if (other instanceof TLongArrayList) {
/*  728 */       TLongArrayList tLongArrayList = (TLongArrayList)other;
/*  729 */       if (tLongArrayList.size() != size()) return false;
/*      */       
/*  731 */       for (int j = this._pos; j-- > 0;) {
/*  732 */         if (this._data[j] != tLongArrayList._data[j]) {
/*  733 */           return false;
/*      */         }
/*      */       } 
/*  736 */       return true;
/*      */     } 
/*      */     
/*  739 */     TLongList that = (TLongList)other;
...
/*  841 */       long midVal = this._data[mid];
/*      */       
/*  843 */       if (midVal < value) {
...
/*  899 */     TLongArrayList list = new TLongArrayList();
...
/*  911 */     TLongArrayList list = new TLongArrayList();
...
/* 1000 */       return (this.cursor < TLongArrayList.this.size());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public long next() {
/*      */       try {
/* 1007 */         long next = TLongArrayList.this.get(this.cursor);
...
/*      */       }
/*      */       try {
/* 1022 */         TLongArrayList.this.remove(this.lastRet, 1);
...
/*      */ 
/*      */     
/* 1062 */     this.no_entry_value = in.readLong();
/*      */ 
/*      */     
/* 1065 */     int len = in.readInt();
/* 1066 */     this._data = new long[len];
/* 1067 */     for (int i = 0; i < len; i++)
/* 1068 */       this._data[i] = in.readLong(); 
/*      */   }
/*      */ }


/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\list\array\TLongArrayList.class
