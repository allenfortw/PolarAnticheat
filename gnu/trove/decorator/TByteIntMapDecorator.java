...
/* 192 */     return new AbstractSet<Map.Entry<Byte, Integer>>() {
/*     */         public int size() {
/* 194 */           return TByteIntMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TByteIntMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TByteIntMapDecorator.this.containsKey(k) && TByteIntMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Byte, Integer>>() {
/* 214 */               private final TByteIntIterator it = TByteIntMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Byte, Integer> next() {
/* 217 */                 this.it.advance();
/* 218 */                 byte ik = this.it.key();
/* 219 */                 final Byte key = (ik == TByteIntMapDecorator.this._map.getNoEntryKey()) ? null : TByteIntMapDecorator.this.wrapKey(ik);
/* 220 */                 int iv = this.it.value();
/* 221 */                 final Integer v = (iv == TByteIntMapDecorator.this._map.getNoEntryValue()) ? null : TByteIntMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Byte, Integer>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TByteIntMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TByteIntMapDecorator.this._map.remove(TByteIntMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TByteIntMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Byte, ? extends Integer>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Byte, ? extends Integer> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TByteIntMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TByteIntMapDecorator.class
