...
/* 192 */     return new AbstractSet<Map.Entry<Float, Integer>>() {
/*     */         public int size() {
/* 194 */           return TFloatIntMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TFloatIntMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TFloatIntMapDecorator.this.containsKey(k) && TFloatIntMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Float, Integer>>() {
/* 214 */               private final TFloatIntIterator it = TFloatIntMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Float, Integer> next() {
/* 217 */                 this.it.advance();
/* 218 */                 float ik = this.it.key();
/* 219 */                 final Float key = (ik == TFloatIntMapDecorator.this._map.getNoEntryKey()) ? null : TFloatIntMapDecorator.this.wrapKey(ik);
/* 220 */                 int iv = this.it.value();
/* 221 */                 final Integer v = (iv == TFloatIntMapDecorator.this._map.getNoEntryValue()) ? null : TFloatIntMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Float, Integer>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TFloatIntMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TFloatIntMapDecorator.this._map.remove(TFloatIntMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TFloatIntMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Float, ? extends Integer>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Float, ? extends Integer> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TFloatIntMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TFloatIntMapDecorator.class
