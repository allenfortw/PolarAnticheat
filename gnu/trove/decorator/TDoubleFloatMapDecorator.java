...
/* 192 */     return new AbstractSet<Map.Entry<Double, Float>>() {
/*     */         public int size() {
/* 194 */           return TDoubleFloatMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TDoubleFloatMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TDoubleFloatMapDecorator.this.containsKey(k) && TDoubleFloatMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Double, Float>>() {
/* 214 */               private final TDoubleFloatIterator it = TDoubleFloatMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Double, Float> next() {
/* 217 */                 this.it.advance();
/* 218 */                 double ik = this.it.key();
/* 219 */                 final Double key = (ik == TDoubleFloatMapDecorator.this._map.getNoEntryKey()) ? null : TDoubleFloatMapDecorator.this.wrapKey(ik);
/* 220 */                 float iv = this.it.value();
/* 221 */                 final Float v = (iv == TDoubleFloatMapDecorator.this._map.getNoEntryValue()) ? null : TDoubleFloatMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Double, Float>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TDoubleFloatMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TDoubleFloatMapDecorator.this._map.remove(TDoubleFloatMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TDoubleFloatMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Double, ? extends Float>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Double, ? extends Float> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TDoubleFloatMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TDoubleFloatMapDecorator.class
