...
/*  405 */     return new TShortFloatHashIterator(this);
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  527 */       return new TShortFloatHashMap.TShortFloatKeyHashIterator((TPrimitiveHash)TShortFloatHashMap.this);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short getNoEntryValue() {
/*  533 */       return TShortFloatHashMap.this.no_entry_key;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int size() {
/*  539 */       return TShortFloatHashMap.this._size;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean isEmpty() {
/*  545 */       return (0 == TShortFloatHashMap.this._size);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean contains(short entry) {
/*  551 */       return TShortFloatHashMap.this.contains(entry);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short[] toArray() {
/*  557 */       return TShortFloatHashMap.this.keys();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short[] toArray(short[] dest) {
/*  563 */       return TShortFloatHashMap.this.keys(dest);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  579 */       return (TShortFloatHashMap.this.no_entry_value != TShortFloatHashMap.this.remove(entry));
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  588 */           if (!TShortFloatHashMap.this.containsKey(ele))
/*  589 */             return false; 
/*      */           continue;
/*      */         } 
/*  592 */         return false;
...
/*  603 */         if (!TShortFloatHashMap.this.containsKey(iter.next())) {
/*  604 */           return false;
/*      */         }
/*      */       } 
/*  607 */       return true;
...
/*  614 */         if (!TShortFloatHashMap.this.contains(element)) {
/*  615 */           return false;
/*      */         }
/*      */       } 
/*  618 */       return true;
...
/*  688 */       short[] set = TShortFloatHashMap.this._set;
/*  689 */       byte[] states = TShortFloatHashMap.this._states;
/*      */       
/*  691 */       for (int i = set.length; i-- > 0;) {
/*  692 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  693 */           TShortFloatHashMap.this.removeAt(i);
/*  694 */           changed = true;
/*      */         } 
/*      */       } 
/*  697 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  748 */       TShortFloatHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean forEach(TShortProcedure procedure) {
/*  754 */       return TShortFloatHashMap.this.forEachKey(procedure);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  765 */         return false;
/*      */       }
/*  767 */       for (int i = TShortFloatHashMap.this._states.length; i-- > 0;) {
/*  768 */         if (TShortFloatHashMap.this._states[i] == 1 && 
/*  769 */           !that.contains(TShortFloatHashMap.this._set[i])) {
/*  770 */           return false;
/*      */         }
/*      */       } 
/*      */       
...
/*      */     public int hashCode() {
/*  780 */       int hashcode = 0;
/*  781 */       for (int i = TShortFloatHashMap.this._states.length; i-- > 0;) {
/*  782 */         if (TShortFloatHashMap.this._states[i] == 1) {
/*  783 */           hashcode += HashFunctions.hash(TShortFloatHashMap.this._set[i]);
/*      */         }
/*      */       } 
/*  786 */       return hashcode;
/*      */     }
...
/*  793 */       TShortFloatHashMap.this.forEachKey(new TShortProcedure()
/*      */           {
...
/*  819 */       return new TShortFloatHashMap.TShortFloatValueHashIterator((TPrimitiveHash)TShortFloatHashMap.this);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public float getNoEntryValue() {
/*  825 */       return TShortFloatHashMap.this.no_entry_value;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int size() {
/*  831 */       return TShortFloatHashMap.this._size;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean isEmpty() {
/*  837 */       return (0 == TShortFloatHashMap.this._size);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean contains(float entry) {
/*  843 */       return TShortFloatHashMap.this.containsValue(entry);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public float[] toArray() {
/*  849 */       return TShortFloatHashMap.this.values();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public float[] toArray(float[] dest) {
/*  855 */       return TShortFloatHashMap.this.values(dest);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  867 */       float[] values = TShortFloatHashMap.this._values;
/*  868 */       byte[] states = TShortFloatHashMap.this._states;
/*      */       
/*  870 */       for (int i = values.length; i-- > 0;) {
/*  871 */         if (states[i] != 0 && states[i] != 2 && entry == values[i]) {
/*  872 */           TShortFloatHashMap.this.removeAt(i);
/*  873 */           return true;
/*      */         } 
/*      */       } 
/*  876 */       return false;
...
/*  884 */           if (!TShortFloatHashMap.this.containsValue(ele))
/*  885 */             return false; 
/*      */           continue;
/*      */         } 
/*  888 */         return false;
...
/*  899 */         if (!TShortFloatHashMap.this.containsValue(iter.next())) {
/*  900 */           return false;
/*      */         }
/*      */       } 
/*  903 */       return true;
...
/*  910 */         if (!TShortFloatHashMap.this.containsValue(element)) {
/*  911 */           return false;
/*      */         }
/*      */       } 
/*  914 */       return true;
...
/*  972 */       float[] values = TShortFloatHashMap.this._values;
/*  973 */       byte[] states = TShortFloatHashMap.this._states;
/*      */       
/*  975 */       for (int i = values.length; i-- > 0;) {
/*  976 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  977 */           TShortFloatHashMap.this.removeAt(i);
/*  978 */           changed = true;
/*      */         } 
/*      */       } 
/*  981 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1032 */       TShortFloatHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean forEach(TFloatProcedure procedure) {
/* 1038 */       return TShortFloatHashMap.this.forEachValue(procedure);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1046 */       TShortFloatHashMap.this.forEachValue(new TFloatProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1080 */       return TShortFloatHashMap.this._set[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1092 */         TShortFloatHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/* 1118 */       return TShortFloatHashMap.this._values[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1130 */         TShortFloatHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/*      */     
/*      */     public short key() {
/* 1159 */       return TShortFloatHashMap.this._set[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float value() {
/* 1164 */       return TShortFloatHashMap.this._values[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public float setValue(float val) {
/* 1169 */       float old = value();
/* 1170 */       TShortFloatHashMap.this._values[this._index] = val;
/* 1171 */       return old;
/*      */     }
/*      */ 
/*      */     
...
/* 1182 */         TShortFloatHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1195 */     if (!(other instanceof TShortFloatMap)) {
/* 1196 */       return false;
/*      */     }
/* 1198 */     TShortFloatMap that = (TShortFloatMap)other;
...
/* 1246 */     forEachEntry(new TShortFloatProcedure()
/*      */         {
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\map\hash\TShortFloatHashMap.class
