...
/*  200 */         if (states[i] == 1 && (val == vals[i] || val
/*  201 */           .equals(vals[i]))) {
/*  202 */           return true;
/*      */         }
/*      */       } 
...
/*  369 */       dest = (V[])Array.newInstance(dest
/*  370 */           .getClass().getComponentType(), this._size);
/*      */     }
/*      */     
...
/*      */       }
/*      */     
/*  490 */     } catch (ClassCastException classCastException) {}
/*      */ 
/*      */     
/*  493 */     return true;
/*      */   }
...
/*  503 */       if (states[i] == 1) {
/*  504 */         hashcode += HashFunctions.hash(this._set[i]) ^ ((values[i] == null) ? 0 : values[i]
/*  505 */           .hashCode());
/*      */       }
/*      */     } 
/*  508 */     return hashcode;
...
/*  562 */         if (!TDoubleObjectHashMap.this.containsKey(((Double)element)
/*  563 */             .doubleValue()))
/*      */         {
/*  565 */           return false;
/*      */         }
...
/*  794 */         if (states[i] == 1 && (
/*  795 */           value == values[i] || (null != values[i] && values[i]
/*  796 */           .equals(value)))) {
...
/*  879 */         a = (T[])Array.newInstance(a
/*  880 */             .getClass().getComponentType(), size);
/*      */       }
/*      */       
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\map\hash\TDoubleObjectHashMap.class
