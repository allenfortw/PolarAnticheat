...
/* 192 */     return new AbstractSet<Map.Entry<Short, Character>>() {
/*     */         public int size() {
/* 194 */           return TShortCharMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TShortCharMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TShortCharMapDecorator.this.containsKey(k) && TShortCharMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Short, Character>>() {
/* 214 */               private final TShortCharIterator it = TShortCharMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Short, Character> next() {
/* 217 */                 this.it.advance();
/* 218 */                 short ik = this.it.key();
/* 219 */                 final Short key = (ik == TShortCharMapDecorator.this._map.getNoEntryKey()) ? null : TShortCharMapDecorator.this.wrapKey(ik);
/* 220 */                 char iv = this.it.value();
/* 221 */                 final Character v = (iv == TShortCharMapDecorator.this._map.getNoEntryValue()) ? null : TShortCharMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Short, Character>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TShortCharMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TShortCharMapDecorator.this._map.remove(TShortCharMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TShortCharMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Short, ? extends Character>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Short, ? extends Character> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TShortCharMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TShortCharMapDecorator.class
