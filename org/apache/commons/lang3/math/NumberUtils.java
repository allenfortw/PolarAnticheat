...
/*      */     } 
/*  680 */     if (pfxLen > 0) {
/*  681 */       char firstSigDigit = Character.MIN_VALUE;
/*  682 */       for (int i = pfxLen; i < length; ) {
/*  683 */         firstSigDigit = str.charAt(i);
/*  684 */         if (firstSigDigit == '0') {
/*  685 */           pfxLen++;
/*      */           
/*      */           i++;
/*      */         } 
...
/*  737 */       boolean bool = (isAllZeros(mant) && isAllZeros(exp));
/*  738 */       switch (lastChar) {
/*      */         case 'L':
/*      */         case 'l':
...
/*  746 */             } catch (NumberFormatException numberFormatException) {
/*      */ 
/*      */               
...
/*  757 */             if (!f.isInfinite() && (f.floatValue() != 0.0F || bool))
/*      */             {
/*      */               
/*  760 */               return f;
/*      */             }
...
/*  771 */             if (!d.isInfinite() && (d.doubleValue() != 0.0D || bool)) {
/*  772 */               return d;
/*      */             }
/*  774 */           } catch (NumberFormatException numberFormatException) {}
/*      */ 
/*      */           
/*      */           try {
...
/*  804 */         } catch (NumberFormatException numberFormatException1) {
/*      */ 
/*      */           
...
/*  816 */         .floatValue() != 0.0F || allZeros) && f
...
/* 1322 */     Validate.notNull(array, "array", new Object[0]);
/* 1323 */     Validate.isTrue((Array.getLength(array) != 0), "Array cannot be empty.", new Object[0]);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */         }
/*      */         
/* 1624 */         for (; j < chars.length; j++) {
/* 1625 */           if ((chars[j] < '0' || chars[j] > '9') && (chars[j] < 'a' || chars[j] > 'f') && (chars[j] < 'A' || chars[j] > 'F'))
/*      */           {
/*      */             
/* 1628 */             return false;
/*      */           }
...
/*      */         
/* 1634 */         int j = start + 1;
/* 1635 */         for (; j < chars.length; j++) {
/* 1636 */           if (chars[j] < '0' || chars[j] > '7') {
/* 1637 */             return false;
/*      */           }
/*      */         } 
/* 1640 */         return true;
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\org\apache\commons\lang3\math\NumberUtils.class
