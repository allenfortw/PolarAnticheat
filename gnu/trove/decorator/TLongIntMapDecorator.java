...
/* 192 */     return new AbstractSet<Map.Entry<Long, Integer>>() {
/*     */         public int size() {
/* 194 */           return TLongIntMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TLongIntMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TLongIntMapDecorator.this.containsKey(k) && TLongIntMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Long, Integer>>() {
/* 214 */               private final TLongIntIterator it = TLongIntMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Long, Integer> next() {
/* 217 */                 this.it.advance();
/* 218 */                 long ik = this.it.key();
/* 219 */                 final Long key = (ik == TLongIntMapDecorator.this._map.getNoEntryKey()) ? null : TLongIntMapDecorator.this.wrapKey(ik);
/* 220 */                 int iv = this.it.value();
/* 221 */                 final Integer v = (iv == TLongIntMapDecorator.this._map.getNoEntryValue()) ? null : TLongIntMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Long, Integer>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TLongIntMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TLongIntMapDecorator.this._map.remove(TLongIntMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TLongIntMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Long, ? extends Integer>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Long, ? extends Integer> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TLongIntMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TLongIntMapDecorator.class
