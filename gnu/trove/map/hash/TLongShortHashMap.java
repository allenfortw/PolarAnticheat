...
/*  405 */     return new TLongShortHashIterator(this);
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  527 */       return new TLongShortHashMap.TLongShortKeyHashIterator((TPrimitiveHash)TLongShortHashMap.this);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public long getNoEntryValue() {
/*  533 */       return TLongShortHashMap.this.no_entry_key;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int size() {
/*  539 */       return TLongShortHashMap.this._size;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean isEmpty() {
/*  545 */       return (0 == TLongShortHashMap.this._size);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean contains(long entry) {
/*  551 */       return TLongShortHashMap.this.contains(entry);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public long[] toArray() {
/*  557 */       return TLongShortHashMap.this.keys();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public long[] toArray(long[] dest) {
/*  563 */       return TLongShortHashMap.this.keys(dest);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  579 */       return (TLongShortHashMap.this.no_entry_value != TLongShortHashMap.this.remove(entry));
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  588 */           if (!TLongShortHashMap.this.containsKey(ele))
/*  589 */             return false; 
/*      */           continue;
/*      */         } 
/*  592 */         return false;
...
/*  603 */         if (!TLongShortHashMap.this.containsKey(iter.next())) {
/*  604 */           return false;
/*      */         }
/*      */       } 
/*  607 */       return true;
...
/*  614 */         if (!TLongShortHashMap.this.contains(element)) {
/*  615 */           return false;
/*      */         }
/*      */       } 
/*  618 */       return true;
...
/*  688 */       long[] set = TLongShortHashMap.this._set;
/*  689 */       byte[] states = TLongShortHashMap.this._states;
/*      */       
/*  691 */       for (int i = set.length; i-- > 0;) {
/*  692 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  693 */           TLongShortHashMap.this.removeAt(i);
/*  694 */           changed = true;
/*      */         } 
/*      */       } 
/*  697 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  748 */       TLongShortHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean forEach(TLongProcedure procedure) {
/*  754 */       return TLongShortHashMap.this.forEachKey(procedure);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  765 */         return false;
/*      */       }
/*  767 */       for (int i = TLongShortHashMap.this._states.length; i-- > 0;) {
/*  768 */         if (TLongShortHashMap.this._states[i] == 1 && 
/*  769 */           !that.contains(TLongShortHashMap.this._set[i])) {
/*  770 */           return false;
/*      */         }
/*      */       } 
/*      */       
...
/*      */     public int hashCode() {
/*  780 */       int hashcode = 0;
/*  781 */       for (int i = TLongShortHashMap.this._states.length; i-- > 0;) {
/*  782 */         if (TLongShortHashMap.this._states[i] == 1) {
/*  783 */           hashcode += HashFunctions.hash(TLongShortHashMap.this._set[i]);
/*      */         }
/*      */       } 
/*  786 */       return hashcode;
/*      */     }
...
/*  793 */       TLongShortHashMap.this.forEachKey(new TLongProcedure()
/*      */           {
...
/*  819 */       return new TLongShortHashMap.TLongShortValueHashIterator((TPrimitiveHash)TLongShortHashMap.this);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short getNoEntryValue() {
/*  825 */       return TLongShortHashMap.this.no_entry_value;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int size() {
/*  831 */       return TLongShortHashMap.this._size;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean isEmpty() {
/*  837 */       return (0 == TLongShortHashMap.this._size);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean contains(short entry) {
/*  843 */       return TLongShortHashMap.this.containsValue(entry);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short[] toArray() {
/*  849 */       return TLongShortHashMap.this.values();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short[] toArray(short[] dest) {
/*  855 */       return TLongShortHashMap.this.values(dest);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  867 */       short[] values = TLongShortHashMap.this._values;
/*  868 */       byte[] states = TLongShortHashMap.this._states;
/*      */       
/*  870 */       for (int i = values.length; i-- > 0;) {
/*  871 */         if (states[i] != 0 && states[i] != 2 && entry == values[i]) {
/*  872 */           TLongShortHashMap.this.removeAt(i);
/*  873 */           return true;
/*      */         } 
/*      */       } 
/*  876 */       return false;
...
/*  884 */           if (!TLongShortHashMap.this.containsValue(ele))
/*  885 */             return false; 
/*      */           continue;
/*      */         } 
/*  888 */         return false;
...
/*  899 */         if (!TLongShortHashMap.this.containsValue(iter.next())) {
/*  900 */           return false;
/*      */         }
/*      */       } 
/*  903 */       return true;
...
/*  910 */         if (!TLongShortHashMap.this.containsValue(element)) {
/*  911 */           return false;
/*      */         }
/*      */       } 
/*  914 */       return true;
...
/*  972 */       short[] values = TLongShortHashMap.this._values;
/*  973 */       byte[] states = TLongShortHashMap.this._states;
/*      */       
/*  975 */       for (int i = values.length; i-- > 0;) {
/*  976 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  977 */           TLongShortHashMap.this.removeAt(i);
/*  978 */           changed = true;
/*      */         } 
/*      */       } 
/*  981 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1032 */       TLongShortHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean forEach(TShortProcedure procedure) {
/* 1038 */       return TLongShortHashMap.this.forEachValue(procedure);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1046 */       TLongShortHashMap.this.forEachValue(new TShortProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1080 */       return TLongShortHashMap.this._set[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1092 */         TLongShortHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/* 1118 */       return TLongShortHashMap.this._values[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1130 */         TLongShortHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/*      */     
/*      */     public long key() {
/* 1159 */       return TLongShortHashMap.this._set[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short value() {
/* 1164 */       return TLongShortHashMap.this._values[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short setValue(short val) {
/* 1169 */       short old = value();
/* 1170 */       TLongShortHashMap.this._values[this._index] = val;
/* 1171 */       return old;
/*      */     }
/*      */ 
/*      */     
...
/* 1182 */         TLongShortHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1195 */     if (!(other instanceof TLongShortMap)) {
/* 1196 */       return false;
/*      */     }
/* 1198 */     TLongShortMap that = (TLongShortMap)other;
...
/* 1246 */     forEachEntry(new TLongShortProcedure()
/*      */         {
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\map\hash\TLongShortHashMap.class
