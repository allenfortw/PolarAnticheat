...
/* 192 */     return new AbstractSet<Map.Entry<Float, Short>>() {
/*     */         public int size() {
/* 194 */           return TFloatShortMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TFloatShortMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TFloatShortMapDecorator.this.containsKey(k) && TFloatShortMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Float, Short>>() {
/* 214 */               private final TFloatShortIterator it = TFloatShortMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Float, Short> next() {
/* 217 */                 this.it.advance();
/* 218 */                 float ik = this.it.key();
/* 219 */                 final Float key = (ik == TFloatShortMapDecorator.this._map.getNoEntryKey()) ? null : TFloatShortMapDecorator.this.wrapKey(ik);
/* 220 */                 short iv = this.it.value();
/* 221 */                 final Short v = (iv == TFloatShortMapDecorator.this._map.getNoEntryValue()) ? null : TFloatShortMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Float, Short>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TFloatShortMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TFloatShortMapDecorator.this._map.remove(TFloatShortMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TFloatShortMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Float, ? extends Short>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Float, ? extends Short> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TFloatShortMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TFloatShortMapDecorator.class
