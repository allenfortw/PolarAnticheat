...
/* 192 */     return new AbstractSet<Map.Entry<Character, Character>>() {
/*     */         public int size() {
/* 194 */           return TCharCharMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TCharCharMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TCharCharMapDecorator.this.containsKey(k) && TCharCharMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Character, Character>>() {
/* 214 */               private final TCharCharIterator it = TCharCharMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Character, Character> next() {
/* 217 */                 this.it.advance();
/* 218 */                 char ik = this.it.key();
/* 219 */                 final Character key = (ik == TCharCharMapDecorator.this._map.getNoEntryKey()) ? null : TCharCharMapDecorator.this.wrapKey(ik);
/* 220 */                 char iv = this.it.value();
/* 221 */                 final Character v = (iv == TCharCharMapDecorator.this._map.getNoEntryValue()) ? null : TCharCharMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Character, Character>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TCharCharMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TCharCharMapDecorator.this._map.remove(TCharCharMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TCharCharMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Character, ? extends Character>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Character, ? extends Character> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TCharCharMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TCharCharMapDecorator.class
