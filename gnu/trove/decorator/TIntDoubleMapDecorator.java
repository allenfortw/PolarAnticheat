...
/* 192 */     return new AbstractSet<Map.Entry<Integer, Double>>() {
/*     */         public int size() {
/* 194 */           return TIntDoubleMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TIntDoubleMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TIntDoubleMapDecorator.this.containsKey(k) && TIntDoubleMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Integer, Double>>() {
/* 214 */               private final TIntDoubleIterator it = TIntDoubleMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Integer, Double> next() {
/* 217 */                 this.it.advance();
/* 218 */                 int ik = this.it.key();
/* 219 */                 final Integer key = (ik == TIntDoubleMapDecorator.this._map.getNoEntryKey()) ? null : TIntDoubleMapDecorator.this.wrapKey(ik);
/* 220 */                 double iv = this.it.value();
/* 221 */                 final Double v = (iv == TIntDoubleMapDecorator.this._map.getNoEntryValue()) ? null : TIntDoubleMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Integer, Double>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TIntDoubleMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TIntDoubleMapDecorator.this._map.remove(TIntDoubleMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TIntDoubleMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Integer, ? extends Double>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Integer, ? extends Double> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TIntDoubleMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TIntDoubleMapDecorator.class
