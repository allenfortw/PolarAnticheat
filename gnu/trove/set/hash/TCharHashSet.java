...
/*     */   
/*     */   public char[] toArray() {
/* 161 */     return toArray(new char[this._size]);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 168 */       dest = new char[this._size];
/*     */     }
/*     */     
/* 171 */     char[] set = this._set;
...
/* 215 */       if (element instanceof Character) {
/* 216 */         char c = ((Character)element).charValue();
/* 217 */         if (!contains(c))
/* 218 */           return false; 
/*     */         continue;
/*     */       } 
...
/* 231 */     TCharIterator iter = collection.iterator();
/* 232 */     while (iter.hasNext()) {
/* 233 */       char element = iter.next();
...
/* 256 */     for (Character element : collection) {
/* 257 */       char e = element.charValue();
/* 258 */       if (add(e)) {
/* 259 */         changed = true;
/*     */       }
/*     */     } 
...
/* 269 */     TCharIterator iter = collection.iterator();
/* 270 */     while (iter.hasNext()) {
/* 271 */       char element = iter.next();
/* 272 */       if (add(element)) {
/* 273 */         changed = true;
/*     */       }
/*     */     } 
...
/* 296 */     TCharIterator iter = iterator();
/* 297 */     while (iter.hasNext()) {
/* 298 */       if (!collection.contains(Character.valueOf(iter.next()))) {
/* 299 */         iter.remove();
/* 300 */         modified = true;
/*     */       } 
/*     */     } 
...
/* 313 */     TCharIterator iter = iterator();
...
/* 348 */       if (element instanceof Character) {
/* 349 */         char c = ((Character)element).charValue();
/* 350 */         if (remove(c)) {
/* 351 */           changed = true;
/*     */         }
/*     */       } 
...
/* 362 */     TCharIterator iter = collection.iterator();
/* 363 */     while (iter.hasNext()) {
/* 364 */       char element = iter.next();
...
/*     */     
/* 402 */     char[] oldSet = this._set;
/* 403 */     byte[] oldStates = this._states;
/*     */     
/* 405 */     this._set = new char[newCapacity];
...
/* 419 */     if (!(other instanceof TCharSet)) {
/* 420 */       return false;
/*     */     }
/* 422 */     TCharSet that = (TCharSet)other;
...
/*     */ 
/*     */     
/* 501 */     out.writeChar(this.no_entry_value);
/*     */ 
/*     */     
/* 504 */     for (int i = this._states.length; i-- > 0;) {
/* 505 */       if (this._states[i] == 1) {
/* 506 */         out.writeChar(this._set[i]);
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/*     */ 
/*     */       
/* 530 */       this.no_entry_value = in.readChar();
/*     */       
/* 532 */       if (this.no_entry_value != '\000') {
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\set\hash\TCharHashSet.class
