...
/*  322 */       array = new double[size];
/*      */     }
/*      */     
/*  325 */     double[] keys = this._set;
...
/*      */   
/*      */   public short[] values() {
/*  345 */     short[] vals = new short[size()];
/*  346 */     if (vals.length == 0) {
/*  347 */       return vals;
/*      */     }
/*  349 */     short[] v = this._values;
...
/*  368 */       array = new short[size];
/*      */     }
/*      */     
/*  371 */     short[] v = this._values;
...
/*  405 */     return new TDoubleShortHashIterator(this);
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  431 */     double[] keys = this._set;
/*  432 */     short[] values = this._values;
...
/*  458 */     double[] keys = this._set;
/*  459 */     short[] values = this._values;
/*      */ 
/*      */ 
/*      */     
...
/*  482 */     return adjustValue(key, (short)1);
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  490 */       return false;
/*      */     }
/*  492 */     this._values[index] = (short)(this._values[index] + amount);
/*  493 */     return true;
/*      */   }
/*      */ 
/*      */   
...
/*  503 */     if (index < 0) {
/*  504 */       index = -index - 1;
/*  505 */       newValue = this._values[index] = (short)(this._values[index] + adjust_amount);
...
/*  527 */       return new TDoubleShortHashMap.TDoubleShortKeyHashIterator((TPrimitiveHash)TDoubleShortHashMap.this);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double getNoEntryValue() {
/*  533 */       return TDoubleShortHashMap.this.no_entry_key;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int size() {
/*  539 */       return TDoubleShortHashMap.this._size;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean isEmpty() {
/*  545 */       return (0 == TDoubleShortHashMap.this._size);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean contains(double entry) {
/*  551 */       return TDoubleShortHashMap.this.contains(entry);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double[] toArray() {
/*  557 */       return TDoubleShortHashMap.this.keys();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double[] toArray(double[] dest) {
/*  563 */       return TDoubleShortHashMap.this.keys(dest);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  579 */       return (TDoubleShortHashMap.this.no_entry_value != TDoubleShortHashMap.this.remove(entry));
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  586 */         if (element instanceof Double) {
/*  587 */           double ele = ((Double)element).doubleValue();
/*  588 */           if (!TDoubleShortHashMap.this.containsKey(ele))
/*  589 */             return false; 
/*      */           continue;
/*      */         } 
/*  592 */         return false;
...
/*  601 */       TDoubleIterator iter = collection.iterator();
/*  602 */       while (iter.hasNext()) {
/*  603 */         if (!TDoubleShortHashMap.this.containsKey(iter.next())) {
/*  604 */           return false;
/*      */         }
/*      */       } 
/*  607 */       return true;
...
/*  613 */       for (double element : array) {
/*  614 */         if (!TDoubleShortHashMap.this.contains(element)) {
/*  615 */           return false;
/*      */         }
/*      */       } 
/*  618 */       return true;
...
/*  656 */       TDoubleIterator iter = iterator();
/*  657 */       while (iter.hasNext()) {
/*  658 */         if (!collection.contains(Double.valueOf(iter.next()))) {
/*  659 */           iter.remove();
/*  660 */           modified = true;
/*      */         } 
/*      */       } 
...
/*  673 */       TDoubleIterator iter = iterator();
...
/*  688 */       double[] set = TDoubleShortHashMap.this._set;
/*  689 */       byte[] states = TDoubleShortHashMap.this._states;
/*      */       
/*  691 */       for (int i = set.length; i-- > 0;) {
/*  692 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  693 */           TDoubleShortHashMap.this.removeAt(i);
/*  694 */           changed = true;
/*      */         } 
/*      */       } 
/*  697 */       return changed;
...
/*  705 */         if (element instanceof Double) {
/*  706 */           double c = ((Double)element).doubleValue();
/*  707 */           if (remove(c)) {
/*  708 */             changed = true;
/*      */           }
/*      */         } 
...
/*  723 */       TDoubleIterator iter = collection.iterator();
/*  724 */       while (iter.hasNext()) {
/*  725 */         double element = iter.next();
...
/*      */     
/*      */     public void clear() {
/*  748 */       TDoubleShortHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean forEach(TDoubleProcedure procedure) {
/*  754 */       return TDoubleShortHashMap.this.forEachKey(procedure);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean equals(Object other) {
/*  760 */       if (!(other instanceof TDoubleSet)) {
/*  761 */         return false;
/*      */       }
/*  763 */       TDoubleSet that = (TDoubleSet)other;
/*  764 */       if (that.size() != size()) {
/*  765 */         return false;
/*      */       }
/*  767 */       for (int i = TDoubleShortHashMap.this._states.length; i-- > 0;) {
/*  768 */         if (TDoubleShortHashMap.this._states[i] == 1 && 
/*  769 */           !that.contains(TDoubleShortHashMap.this._set[i])) {
/*  770 */           return false;
/*      */         }
/*      */       } 
/*      */       
...
/*      */     public int hashCode() {
/*  780 */       int hashcode = 0;
/*  781 */       for (int i = TDoubleShortHashMap.this._states.length; i-- > 0;) {
/*  782 */         if (TDoubleShortHashMap.this._states[i] == 1) {
/*  783 */           hashcode += HashFunctions.hash(TDoubleShortHashMap.this._set[i]);
/*      */         }
/*      */       } 
/*  786 */       return hashcode;
/*      */     }
...
/*  793 */       TDoubleShortHashMap.this.forEachKey(new TDoubleProcedure()
/*      */           {
...
/*  819 */       return new TDoubleShortHashMap.TDoubleShortValueHashIterator((TPrimitiveHash)TDoubleShortHashMap.this);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short getNoEntryValue() {
/*  825 */       return TDoubleShortHashMap.this.no_entry_value;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int size() {
/*  831 */       return TDoubleShortHashMap.this._size;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean isEmpty() {
/*  837 */       return (0 == TDoubleShortHashMap.this._size);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean contains(short entry) {
/*  843 */       return TDoubleShortHashMap.this.containsValue(entry);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short[] toArray() {
/*  849 */       return TDoubleShortHashMap.this.values();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public short[] toArray(short[] dest) {
/*  855 */       return TDoubleShortHashMap.this.values(dest);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  867 */       short[] values = TDoubleShortHashMap.this._values;
/*  868 */       byte[] states = TDoubleShortHashMap.this._states;
/*      */       
/*  870 */       for (int i = values.length; i-- > 0;) {
/*  871 */         if (states[i] != 0 && states[i] != 2 && entry == values[i]) {
/*  872 */           TDoubleShortHashMap.this.removeAt(i);
/*  873 */           return true;
/*      */         } 
/*      */       } 
/*  876 */       return false;
...
/*  883 */           short ele = ((Short)element).shortValue();
/*  884 */           if (!TDoubleShortHashMap.this.containsValue(ele))
/*  885 */             return false; 
/*      */           continue;
/*      */         } 
/*  888 */         return false;
...
/*  897 */       TShortIterator iter = collection.iterator();
/*  898 */       while (iter.hasNext()) {
/*  899 */         if (!TDoubleShortHashMap.this.containsValue(iter.next())) {
/*  900 */           return false;
/*      */         }
/*      */       } 
/*  903 */       return true;
...
/*  909 */       for (short element : array) {
/*  910 */         if (!TDoubleShortHashMap.this.containsValue(element)) {
/*  911 */           return false;
/*      */         }
/*      */       } 
/*  914 */       return true;
...
/*  940 */       TShortIterator iter = iterator();
/*  941 */       while (iter.hasNext()) {
/*  942 */         if (!collection.contains(Short.valueOf(iter.next()))) {
/*  943 */           iter.remove();
/*  944 */           modified = true;
/*      */         } 
/*      */       } 
...
/*  957 */       TShortIterator iter = iterator();
...
/*  972 */       short[] values = TDoubleShortHashMap.this._values;
/*  973 */       byte[] states = TDoubleShortHashMap.this._states;
/*      */       
/*  975 */       for (int i = values.length; i-- > 0;) {
/*  976 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  977 */           TDoubleShortHashMap.this.removeAt(i);
/*  978 */           changed = true;
/*      */         } 
/*      */       } 
/*  981 */       return changed;
...
/*  989 */         if (element instanceof Short) {
/*  990 */           short c = ((Short)element).shortValue();
/*  991 */           if (remove(c)) {
/*  992 */             changed = true;
/*      */           }
/*      */         } 
...
/* 1007 */       TShortIterator iter = collection.iterator();
/* 1008 */       while (iter.hasNext()) {
/* 1009 */         short element = iter.next();
...
/*      */     
/*      */     public void clear() {
/* 1032 */       TDoubleShortHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean forEach(TShortProcedure procedure) {
/* 1038 */       return TDoubleShortHashMap.this.forEachValue(procedure);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1046 */       TDoubleShortHashMap.this.forEachValue(new TShortProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1080 */       return TDoubleShortHashMap.this._set[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1092 */         TDoubleShortHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/* 1118 */       return TDoubleShortHashMap.this._values[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1130 */         TDoubleShortHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/*      */     
/*      */     public double key() {
/* 1159 */       return TDoubleShortHashMap.this._set[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short value() {
/* 1164 */       return TDoubleShortHashMap.this._values[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public short setValue(short val) {
/* 1169 */       short old = value();
/* 1170 */       TDoubleShortHashMap.this._values[this._index] = val;
/* 1171 */       return old;
/*      */     }
/*      */ 
/*      */     
...
/* 1182 */         TDoubleShortHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1195 */     if (!(other instanceof TDoubleShortMap)) {
/* 1196 */       return false;
/*      */     }
/* 1198 */     TDoubleShortMap that = (TDoubleShortMap)other;
/* 1199 */     if (that.size() != size()) {
/* 1200 */       return false;
/*      */     }
/* 1202 */     short[] values = this._values;
/* 1203 */     byte[] states = this._states;
/* 1204 */     short this_no_entry_value = getNoEntryValue();
/* 1205 */     short that_no_entry_value = that.getNoEntryValue();
/* 1206 */     for (int i = values.length; i-- > 0;) {
/* 1207 */       if (states[i] == 1) {
/* 1208 */         double key = this._set[i];
/*      */         
/* 1210 */         if (!that.containsKey(key)) return false;
/*      */         
/* 1212 */         short that_value = that.get(key);
/* 1213 */         short this_value = values[i];
...
/* 1246 */     forEachEntry(new TDoubleShortProcedure()
/*      */         {
...
/* 1277 */         out.writeDouble(this._set[i]);
/* 1278 */         out.writeShort(this._values[i]);
/*      */       } 
/*      */     } 
/*      */   }
/*      */ 
...
/*      */     
/* 1297 */     while (size-- > 0) {
/* 1298 */       double key = in.readDouble();
/* 1299 */       short val = in.readShort();
/* 1300 */       put(key, val);
/*      */     } 
/*      */   }
/*      */ }
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\map\hash\TDoubleShortHashMap.class
