...
/* 192 */       register(object);
/*     */       
/* 194 */       Field[] fields = (Field[])ArraySorter.sort((Object[])clazz.getDeclaredFields(), Comparator.comparing(Field::getName));
/* 195 */       AccessibleObject.setAccessible((AccessibleObject[])fields, true);
/* 196 */       for (Field field : fields) {
/* 197 */         if (!ArrayUtils.contains((Object[])excludeFields, field.getName()) && 
...
/* 201 */           !field.isAnnotationPresent((Class)HashCodeExclude.class)) {
/*     */           try {
/* 203 */             Object fieldValue = field.get(object);
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\org\apache\commons\lang3\builder\HashCodeBuilder.class
