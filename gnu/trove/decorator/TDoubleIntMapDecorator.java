...
/* 192 */     return new AbstractSet<Map.Entry<Double, Integer>>() {
/*     */         public int size() {
/* 194 */           return TDoubleIntMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TDoubleIntMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TDoubleIntMapDecorator.this.containsKey(k) && TDoubleIntMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Double, Integer>>() {
/* 214 */               private final TDoubleIntIterator it = TDoubleIntMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Double, Integer> next() {
/* 217 */                 this.it.advance();
/* 218 */                 double ik = this.it.key();
/* 219 */                 final Double key = (ik == TDoubleIntMapDecorator.this._map.getNoEntryKey()) ? null : TDoubleIntMapDecorator.this.wrapKey(ik);
/* 220 */                 int iv = this.it.value();
/* 221 */                 final Integer v = (iv == TDoubleIntMapDecorator.this._map.getNoEntryValue()) ? null : TDoubleIntMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Double, Integer>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TDoubleIntMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TDoubleIntMapDecorator.this._map.remove(TDoubleIntMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TDoubleIntMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Double, ? extends Integer>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Double, ? extends Integer> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TDoubleIntMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TDoubleIntMapDecorator.class
