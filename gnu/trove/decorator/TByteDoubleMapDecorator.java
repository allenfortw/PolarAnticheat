...
/* 192 */     return new AbstractSet<Map.Entry<Byte, Double>>() {
/*     */         public int size() {
/* 194 */           return TByteDoubleMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TByteDoubleMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TByteDoubleMapDecorator.this.containsKey(k) && TByteDoubleMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Byte, Double>>() {
/* 214 */               private final TByteDoubleIterator it = TByteDoubleMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Byte, Double> next() {
/* 217 */                 this.it.advance();
/* 218 */                 byte ik = this.it.key();
/* 219 */                 final Byte key = (ik == TByteDoubleMapDecorator.this._map.getNoEntryKey()) ? null : TByteDoubleMapDecorator.this.wrapKey(ik);
/* 220 */                 double iv = this.it.value();
/* 221 */                 final Double v = (iv == TByteDoubleMapDecorator.this._map.getNoEntryValue()) ? null : TByteDoubleMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Byte, Double>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TByteDoubleMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TByteDoubleMapDecorator.this._map.remove(TByteDoubleMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TByteDoubleMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Byte, ? extends Double>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Byte, ? extends Double> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TByteDoubleMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TByteDoubleMapDecorator.class
