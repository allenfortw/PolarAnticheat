...
/*  154 */       this._loadFactor = Math.abs(hashmap._loadFactor);
...
/*      */       }
/*  161 */       setUp(saturatedCast(fastCeil(10.0D / this._loadFactor)));
/*      */     } 
/*  163 */     putAll(map);
/*      */   }
/*      */ 
...
/*  603 */           if (that.get(key) != that.getNoEntryValue() || 
/*  604 */             !that.containsKey(key))
/*      */           {
/*  606 */             return false; } 
/*      */           continue;
/*      */         } 
...
/*      */       }
/*      */     
/*  614 */     } catch (ClassCastException classCastException) {}
/*      */ 
/*      */     
/*  617 */     return true;
/*      */   }
...
/*      */       {
/*  696 */         a = (T[])Array.newInstance(a
/*  697 */             .getClass().getComponentType(), size);
/*      */       }
/*      */       
...
/*  880 */         if (set[i] != TObjectHash.FREE && set[i] != TObjectHash.REMOVED && 
/*      */           
/*  882 */           Arrays.binarySearch(array, values[i]) < 0) {
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\map\custom_hash\TObjectDoubleCustomHashMap.class
