...
/* 299 */       if (set[i] != FREE && set[i] != REMOVED && 
/*     */         
/* 301 */         !procedure.execute(values[i])) {
/* 302 */         return false;
/*     */       }
/*     */     } 
/* 305 */     return true;
...
/*     */         
/* 324 */         !procedure.execute(keys[i], values[i])) {
/* 325 */         return false;
/*     */       }
/*     */     } 
/* 328 */     return true;
...
/* 349 */         if (keys[i] != FREE && keys[i] != REMOVED && 
/*     */           
/* 351 */           !procedure.execute(keys[i], values[i])) {
/* 352 */           removeAt(i);
/* 353 */           modified = true;
/*     */         } 
/*     */       } 
...
/* 521 */         if (set[i] != FREE && set[i] != REMOVED && (val == vals[i] || this.strategy
/* 522 */           .equals(val, vals[i]))) {
/* 523 */           return true;
/*     */         }
/*     */       } 
/*     */     } 
...
/* 579 */         if ((set[i] != TObjectHash.FREE && set[i] != TObjectHash.REMOVED && value == arrayOfV[i]) || (null != arrayOfV[i] && TCustomHashMap.this
/*     */           
/* 581 */           .strategy.equals(arrayOfV[i], value))) {
/*     */           
...
/* 632 */         if (val == TCustomHashMap.this._values[index] || (null != val && TCustomHashMap.this
/* 633 */           .strategy.equals(val, TCustomHashMap.this._values[index]))) {
...
/* 645 */       return (entryValue == val || (null != val && TCustomHashMap.this
/* 646 */         .strategy.equals(val, entryValue)));
/*     */     }
/*     */ 
/*     */     
...
/* 838 */         if ((e1.getKey() == null) ? (e2.getKey() == null) : TCustomHashMap.this
/* 839 */           .strategy.equals(e1.getKey(), e2.getKey()))
/* 840 */           if ((e1.getValue() == null) ? (e2.getValue() == null) : e1
/* 841 */             .getValue().equals(e2.getValue()));  return false;
/*     */       } 
/* 843 */       return false;
/*     */     }
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\map\hash\TCustomHashMap.class
