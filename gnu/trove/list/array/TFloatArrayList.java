...
/*   92 */     this._data = new float[capacity];
/*   93 */     this._pos = 0;
...
/*  163 */     return new TFloatArrayList(values, no_entry_value, true)
/*      */       {
/*      */ 
/*      */         
...
/*  191 */       float[] tmp = new float[newCap];
...
/*      */     }
/*      */     
/*  306 */     float prev_val = this._data[offset];
...
/*      */     }
/*  317 */     float old = this._data[offset];
...
/*  414 */     return new TFloatArrayIterator(0);
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  421 */       if (element instanceof Float) {
/*  422 */         float c = ((Float)element).floatValue();
/*  423 */         if (!contains(c))
/*  424 */           return false; 
/*      */         continue;
/*      */       } 
...
/*  438 */       return true;
/*      */     }
/*  440 */     TFloatIterator iter = collection.iterator();
/*  441 */     while (iter.hasNext()) {
/*  442 */       float element = iter.next();
...
/*  465 */     for (Float element : collection) {
/*  466 */       float e = element.floatValue();
/*  467 */       if (add(e)) {
/*  468 */         changed = true;
/*      */       }
/*      */     } 
...
/*  478 */     TFloatIterator iter = collection.iterator();
/*  479 */     while (iter.hasNext()) {
/*  480 */       float element = iter.next();
/*  481 */       if (add(element)) {
/*  482 */         changed = true;
/*      */       }
/*      */     } 
...
/*  505 */     TFloatIterator iter = iterator();
/*  506 */     while (iter.hasNext()) {
/*  507 */       if (!collection.contains(Float.valueOf(iter.next()))) {
/*  508 */         iter.remove();
/*  509 */         modified = true;
/*      */       } 
/*      */     } 
...
/*  522 */     TFloatIterator iter = iterator();
...
/*  553 */       if (element instanceof Float) {
/*  554 */         float c = ((Float)element).floatValue();
/*  555 */         if (remove(c)) {
/*  556 */           changed = true;
/*      */         }
/*      */       } 
...
/*  571 */     TFloatIterator iter = collection.iterator();
/*  572 */     while (iter.hasNext()) {
/*  573 */       float element = iter.next();
...
/*      */     }
/*  657 */     TFloatArrayList list = new TFloatArrayList(end - begin);
...
/*  723 */       return true;
/*      */     }
/*  725 */     if (!(other instanceof TFloatList)) return false;
/*      */     
/*  727 */     if (other instanceof TFloatArrayList) {
/*  728 */       TFloatArrayList tFloatArrayList = (TFloatArrayList)other;
/*  729 */       if (tFloatArrayList.size() != size()) return false;
/*      */       
/*  731 */       for (int j = this._pos; j-- > 0;) {
/*  732 */         if (this._data[j] != tFloatArrayList._data[j]) {
/*  733 */           return false;
/*      */         }
/*      */       } 
/*  736 */       return true;
/*      */     } 
/*      */     
/*  739 */     TFloatList that = (TFloatList)other;
...
/*  841 */       float midVal = this._data[mid];
/*      */       
/*  843 */       if (midVal < value) {
...
/*  899 */     TFloatArrayList list = new TFloatArrayList();
...
/*  911 */     TFloatArrayList list = new TFloatArrayList();
...
/*      */     }
/*  926 */     float max = Float.NEGATIVE_INFINITY;
...
/*      */     }
/*  941 */     float min = Float.POSITIVE_INFINITY;
...
/* 1000 */       return (this.cursor < TFloatArrayList.this.size());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public float next() {
/*      */       try {
/* 1007 */         float next = TFloatArrayList.this.get(this.cursor);
...
/*      */       }
/*      */       try {
/* 1022 */         TFloatArrayList.this.remove(this.lastRet, 1);
...
/*      */ 
/*      */     
/* 1062 */     this.no_entry_value = in.readFloat();
/*      */ 
/*      */     
/* 1065 */     int len = in.readInt();
/* 1066 */     this._data = new float[len];
/* 1067 */     for (int i = 0; i < len; i++)
/* 1068 */       this._data[i] = in.readFloat(); 
/*      */   }
/*      */ }


/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\list\array\TFloatArrayList.class
