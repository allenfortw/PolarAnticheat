...
/*  405 */     return new TByteCharHashIterator(this);
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  527 */       return new TByteCharHashMap.TByteCharKeyHashIterator((TPrimitiveHash)TByteCharHashMap.this);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public byte getNoEntryValue() {
/*  533 */       return TByteCharHashMap.this.no_entry_key;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int size() {
/*  539 */       return TByteCharHashMap.this._size;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean isEmpty() {
/*  545 */       return (0 == TByteCharHashMap.this._size);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean contains(byte entry) {
/*  551 */       return TByteCharHashMap.this.contains(entry);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public byte[] toArray() {
/*  557 */       return TByteCharHashMap.this.keys();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public byte[] toArray(byte[] dest) {
/*  563 */       return TByteCharHashMap.this.keys(dest);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  579 */       return (TByteCharHashMap.this.no_entry_value != TByteCharHashMap.this.remove(entry));
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  588 */           if (!TByteCharHashMap.this.containsKey(ele))
/*  589 */             return false; 
/*      */           continue;
/*      */         } 
/*  592 */         return false;
...
/*  603 */         if (!TByteCharHashMap.this.containsKey(iter.next())) {
/*  604 */           return false;
/*      */         }
/*      */       } 
/*  607 */       return true;
...
/*  614 */         if (!TByteCharHashMap.this.contains(element)) {
/*  615 */           return false;
/*      */         }
/*      */       } 
/*  618 */       return true;
...
/*  688 */       byte[] set = TByteCharHashMap.this._set;
/*  689 */       byte[] states = TByteCharHashMap.this._states;
/*      */       
/*  691 */       for (int i = set.length; i-- > 0;) {
/*  692 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  693 */           TByteCharHashMap.this.removeAt(i);
/*  694 */           changed = true;
/*      */         } 
/*      */       } 
/*  697 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  748 */       TByteCharHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean forEach(TByteProcedure procedure) {
/*  754 */       return TByteCharHashMap.this.forEachKey(procedure);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  765 */         return false;
/*      */       }
/*  767 */       for (int i = TByteCharHashMap.this._states.length; i-- > 0;) {
/*  768 */         if (TByteCharHashMap.this._states[i] == 1 && 
/*  769 */           !that.contains(TByteCharHashMap.this._set[i])) {
/*  770 */           return false;
/*      */         }
/*      */       } 
/*      */       
...
/*      */     public int hashCode() {
/*  780 */       int hashcode = 0;
/*  781 */       for (int i = TByteCharHashMap.this._states.length; i-- > 0;) {
/*  782 */         if (TByteCharHashMap.this._states[i] == 1) {
/*  783 */           hashcode += HashFunctions.hash(TByteCharHashMap.this._set[i]);
/*      */         }
/*      */       } 
/*  786 */       return hashcode;
/*      */     }
...
/*  793 */       TByteCharHashMap.this.forEachKey(new TByteProcedure()
/*      */           {
...
/*  819 */       return new TByteCharHashMap.TByteCharValueHashIterator((TPrimitiveHash)TByteCharHashMap.this);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public char getNoEntryValue() {
/*  825 */       return TByteCharHashMap.this.no_entry_value;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int size() {
/*  831 */       return TByteCharHashMap.this._size;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean isEmpty() {
/*  837 */       return (0 == TByteCharHashMap.this._size);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean contains(char entry) {
/*  843 */       return TByteCharHashMap.this.containsValue(entry);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public char[] toArray() {
/*  849 */       return TByteCharHashMap.this.values();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public char[] toArray(char[] dest) {
/*  855 */       return TByteCharHashMap.this.values(dest);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  867 */       char[] values = TByteCharHashMap.this._values;
/*  868 */       byte[] states = TByteCharHashMap.this._states;
/*      */       
/*  870 */       for (int i = values.length; i-- > 0;) {
/*  871 */         if (states[i] != 0 && states[i] != 2 && entry == values[i]) {
/*  872 */           TByteCharHashMap.this.removeAt(i);
/*  873 */           return true;
/*      */         } 
/*      */       } 
/*  876 */       return false;
...
/*  884 */           if (!TByteCharHashMap.this.containsValue(ele))
/*  885 */             return false; 
/*      */           continue;
/*      */         } 
/*  888 */         return false;
...
/*  899 */         if (!TByteCharHashMap.this.containsValue(iter.next())) {
/*  900 */           return false;
/*      */         }
/*      */       } 
/*  903 */       return true;
...
/*  910 */         if (!TByteCharHashMap.this.containsValue(element)) {
/*  911 */           return false;
/*      */         }
/*      */       } 
/*  914 */       return true;
...
/*  972 */       char[] values = TByteCharHashMap.this._values;
/*  973 */       byte[] states = TByteCharHashMap.this._states;
/*      */       
/*  975 */       for (int i = values.length; i-- > 0;) {
/*  976 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  977 */           TByteCharHashMap.this.removeAt(i);
/*  978 */           changed = true;
/*      */         } 
/*      */       } 
/*  981 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1032 */       TByteCharHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean forEach(TCharProcedure procedure) {
/* 1038 */       return TByteCharHashMap.this.forEachValue(procedure);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1046 */       TByteCharHashMap.this.forEachValue(new TCharProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1080 */       return TByteCharHashMap.this._set[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1092 */         TByteCharHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/* 1118 */       return TByteCharHashMap.this._values[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1130 */         TByteCharHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/*      */     
/*      */     public byte key() {
/* 1159 */       return TByteCharHashMap.this._set[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char value() {
/* 1164 */       return TByteCharHashMap.this._values[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public char setValue(char val) {
/* 1169 */       char old = value();
/* 1170 */       TByteCharHashMap.this._values[this._index] = val;
/* 1171 */       return old;
/*      */     }
/*      */ 
/*      */     
...
/* 1182 */         TByteCharHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1195 */     if (!(other instanceof TByteCharMap)) {
/* 1196 */       return false;
/*      */     }
/* 1198 */     TByteCharMap that = (TByteCharMap)other;
...
/* 1246 */     forEachEntry(new TByteCharProcedure()
/*      */         {
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\map\hash\TByteCharHashMap.class
