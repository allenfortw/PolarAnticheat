...
/* 135 */     Validate.notNull(name, "name", new Object[0]);
/* 136 */     Validate.notNull(backgroundInitializer, "backgroundInitializer", new Object[0]);
/*     */     
...
/* 199 */     for (Map.Entry<String, BackgroundInitializer<?>> e : inits.entrySet()) {
/*     */       try {
...
/* 301 */       checkName(name);
/* 302 */       return this.exceptions.get(name);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 336 */       BackgroundInitializer<?> init = this.initializers.get(name);
/* 337 */       if (init == null) {
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\org\apache\commons\lang3\concurrent\MultiBackgroundInitializer.class
