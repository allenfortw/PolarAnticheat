...
/* 192 */     return new AbstractSet<Map.Entry<Integer, Short>>() {
/*     */         public int size() {
/* 194 */           return TIntShortMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TIntShortMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TIntShortMapDecorator.this.containsKey(k) && TIntShortMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Integer, Short>>() {
/* 214 */               private final TIntShortIterator it = TIntShortMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Integer, Short> next() {
/* 217 */                 this.it.advance();
/* 218 */                 int ik = this.it.key();
/* 219 */                 final Integer key = (ik == TIntShortMapDecorator.this._map.getNoEntryKey()) ? null : TIntShortMapDecorator.this.wrapKey(ik);
/* 220 */                 short iv = this.it.value();
/* 221 */                 final Short v = (iv == TIntShortMapDecorator.this._map.getNoEntryValue()) ? null : TIntShortMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Integer, Short>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TIntShortMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TIntShortMapDecorator.this._map.remove(TIntShortMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TIntShortMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Integer, ? extends Short>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Integer, ? extends Short> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TIntShortMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TIntShortMapDecorator.class
