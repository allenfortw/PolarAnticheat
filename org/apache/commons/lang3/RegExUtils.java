...
/* 259 */     if (ObjectUtils.anyNull(new Object[] { text, regex, replacement })) {
/* 260 */       return text;
/*     */     }
...
/* 313 */     if (ObjectUtils.anyNull(new Object[] { text, regex, replacement })) {
/* 314 */       return text;
/*     */     }
...
/* 452 */     if (ObjectUtils.anyNull(new Object[] { text, regex, replacement })) {
/* 453 */       return text;
/*     */     }
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\org\apache\commons\lang3\RegExUtils.class
