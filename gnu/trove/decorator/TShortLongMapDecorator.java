...
/* 192 */     return new AbstractSet<Map.Entry<Short, Long>>() {
/*     */         public int size() {
/* 194 */           return TShortLongMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TShortLongMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TShortLongMapDecorator.this.containsKey(k) && TShortLongMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Short, Long>>() {
/* 214 */               private final TShortLongIterator it = TShortLongMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Short, Long> next() {
/* 217 */                 this.it.advance();
/* 218 */                 short ik = this.it.key();
/* 219 */                 final Short key = (ik == TShortLongMapDecorator.this._map.getNoEntryKey()) ? null : TShortLongMapDecorator.this.wrapKey(ik);
/* 220 */                 long iv = this.it.value();
/* 221 */                 final Long v = (iv == TShortLongMapDecorator.this._map.getNoEntryValue()) ? null : TShortLongMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Short, Long>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TShortLongMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TShortLongMapDecorator.this._map.remove(TShortLongMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TShortLongMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Short, ? extends Long>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Short, ? extends Long> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TShortLongMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TShortLongMapDecorator.class
