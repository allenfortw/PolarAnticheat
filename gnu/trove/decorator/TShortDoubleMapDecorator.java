...
/* 192 */     return new AbstractSet<Map.Entry<Short, Double>>() {
/*     */         public int size() {
/* 194 */           return TShortDoubleMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TShortDoubleMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TShortDoubleMapDecorator.this.containsKey(k) && TShortDoubleMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Short, Double>>() {
/* 214 */               private final TShortDoubleIterator it = TShortDoubleMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Short, Double> next() {
/* 217 */                 this.it.advance();
/* 218 */                 short ik = this.it.key();
/* 219 */                 final Short key = (ik == TShortDoubleMapDecorator.this._map.getNoEntryKey()) ? null : TShortDoubleMapDecorator.this.wrapKey(ik);
/* 220 */                 double iv = this.it.value();
/* 221 */                 final Double v = (iv == TShortDoubleMapDecorator.this._map.getNoEntryValue()) ? null : TShortDoubleMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Short, Double>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TShortDoubleMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TShortDoubleMapDecorator.this._map.remove(TShortDoubleMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TShortDoubleMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Short, ? extends Double>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Short, ? extends Double> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TShortDoubleMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TShortDoubleMapDecorator.class
