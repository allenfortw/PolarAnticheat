...
/* 192 */     return new AbstractSet<Map.Entry<Long, Float>>() {
/*     */         public int size() {
/* 194 */           return TLongFloatMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TLongFloatMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TLongFloatMapDecorator.this.containsKey(k) && TLongFloatMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Long, Float>>() {
/* 214 */               private final TLongFloatIterator it = TLongFloatMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Long, Float> next() {
/* 217 */                 this.it.advance();
/* 218 */                 long ik = this.it.key();
/* 219 */                 final Long key = (ik == TLongFloatMapDecorator.this._map.getNoEntryKey()) ? null : TLongFloatMapDecorator.this.wrapKey(ik);
/* 220 */                 float iv = this.it.value();
/* 221 */                 final Float v = (iv == TLongFloatMapDecorator.this._map.getNoEntryValue()) ? null : TLongFloatMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Long, Float>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TLongFloatMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TLongFloatMapDecorator.this._map.remove(TLongFloatMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TLongFloatMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Long, ? extends Float>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Long, ? extends Float> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TLongFloatMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TLongFloatMapDecorator.class
