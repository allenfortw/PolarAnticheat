...
/* 192 */     return new AbstractSet<Map.Entry<Long, Byte>>() {
/*     */         public int size() {
/* 194 */           return TLongByteMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TLongByteMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TLongByteMapDecorator.this.containsKey(k) && TLongByteMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Long, Byte>>() {
/* 214 */               private final TLongByteIterator it = TLongByteMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Long, Byte> next() {
/* 217 */                 this.it.advance();
/* 218 */                 long ik = this.it.key();
/* 219 */                 final Long key = (ik == TLongByteMapDecorator.this._map.getNoEntryKey()) ? null : TLongByteMapDecorator.this.wrapKey(ik);
/* 220 */                 byte iv = this.it.value();
/* 221 */                 final Byte v = (iv == TLongByteMapDecorator.this._map.getNoEntryValue()) ? null : TLongByteMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Long, Byte>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TLongByteMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TLongByteMapDecorator.this._map.remove(TLongByteMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TLongByteMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Long, ? extends Byte>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Long, ? extends Byte> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TLongByteMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TLongByteMapDecorator.class
