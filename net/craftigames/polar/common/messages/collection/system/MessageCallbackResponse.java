...
/*    */ 
/*    */ @MessageIdentifier(legacyId = 43)
/*    */ public class MessageCallbackResponse extends Message implements PendingRequestResponseMessage {
/*    */   private UUID user;
/*    */   private UUID uuid;
/*    */   private JsonElement data;
/*    */   
/*    */   public MessageCallbackResponse(UUID user, UUID uuid, JsonElement data) {
/* 17 */     this.user = user; this.uuid = uuid; this.data = data;
/*    */   }
/*    */   public MessageCallbackResponse() {}
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\net\craftigames\polar\common\messages\collection\system\MessageCallbackResponse.class
