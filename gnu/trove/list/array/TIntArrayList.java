...
/*   92 */     this._data = new int[capacity];
/*   93 */     this._pos = 0;
...
/*  163 */     return new TIntArrayList(values, no_entry_value, true)
/*      */       {
/*      */ 
/*      */         
...
/*      */     }
/*      */     
/*  306 */     int prev_val = this._data[offset];
...
/*  414 */     return new TIntArrayIterator(0);
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  421 */       if (element instanceof Integer) {
/*  422 */         int c = ((Integer)element).intValue();
/*  423 */         if (!contains(c))
/*  424 */           return false; 
/*      */         continue;
/*      */       } 
...
/*  438 */       return true;
/*      */     }
/*  440 */     TIntIterator iter = collection.iterator();
/*  441 */     while (iter.hasNext()) {
/*  442 */       int element = iter.next();
...
/*  465 */     for (Integer element : collection) {
/*  466 */       int e = element.intValue();
/*  467 */       if (add(e)) {
/*  468 */         changed = true;
/*      */       }
/*      */     } 
...
/*  478 */     TIntIterator iter = collection.iterator();
/*  479 */     while (iter.hasNext()) {
/*  480 */       int element = iter.next();
/*  481 */       if (add(element)) {
/*  482 */         changed = true;
/*      */       }
/*      */     } 
...
/*  505 */     TIntIterator iter = iterator();
/*  506 */     while (iter.hasNext()) {
/*  507 */       if (!collection.contains(Integer.valueOf(iter.next()))) {
/*  508 */         iter.remove();
/*  509 */         modified = true;
/*      */       } 
/*      */     } 
...
/*  522 */     TIntIterator iter = iterator();
...
/*  553 */       if (element instanceof Integer) {
/*  554 */         int c = ((Integer)element).intValue();
/*  555 */         if (remove(c)) {
/*  556 */           changed = true;
/*      */         }
/*      */       } 
...
/*  571 */     TIntIterator iter = collection.iterator();
/*  572 */     while (iter.hasNext()) {
/*  573 */       int element = iter.next();
...
/*      */     }
/*  657 */     TIntArrayList list = new TIntArrayList(end - begin);
...
/*  723 */       return true;
/*      */     }
/*  725 */     if (!(other instanceof TIntList)) return false;
/*      */     
/*  727 */     if (other instanceof TIntArrayList) {
/*  728 */       TIntArrayList tIntArrayList = (TIntArrayList)other;
/*  729 */       if (tIntArrayList.size() != size()) return false;
/*      */       
/*  731 */       for (int j = this._pos; j-- > 0;) {
/*  732 */         if (this._data[j] != tIntArrayList._data[j]) {
/*  733 */           return false;
/*      */         }
/*      */       } 
/*  736 */       return true;
/*      */     } 
/*      */     
/*  739 */     TIntList that = (TIntList)other;
...
/*  899 */     TIntArrayList list = new TIntArrayList();
...
/*  911 */     TIntArrayList list = new TIntArrayList();
...
/* 1000 */       return (this.cursor < TIntArrayList.this.size());
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int next() {
/*      */       try {
/* 1007 */         int next = TIntArrayList.this.get(this.cursor);
...
/*      */       }
/*      */       try {
/* 1022 */         TIntArrayList.this.remove(this.lastRet, 1);
...
/*      */ 
/*      */     
/* 1062 */     this.no_entry_value = in.readInt();
/*      */ 
/*      */     
/* 1065 */     int len = in.readInt();
/* 1066 */     this._data = new int[len];
/* 1067 */     for (int i = 0; i < len; i++)
/* 1068 */       this._data[i] = in.readInt(); 
/*      */   }
/*      */ }


/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\list\array\TIntArrayList.class
