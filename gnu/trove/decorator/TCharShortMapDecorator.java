...
/* 192 */     return new AbstractSet<Map.Entry<Character, Short>>() {
/*     */         public int size() {
/* 194 */           return TCharShortMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TCharShortMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TCharShortMapDecorator.this.containsKey(k) && TCharShortMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Character, Short>>() {
/* 214 */               private final TCharShortIterator it = TCharShortMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Character, Short> next() {
/* 217 */                 this.it.advance();
/* 218 */                 char ik = this.it.key();
/* 219 */                 final Character key = (ik == TCharShortMapDecorator.this._map.getNoEntryKey()) ? null : TCharShortMapDecorator.this.wrapKey(ik);
/* 220 */                 short iv = this.it.value();
/* 221 */                 final Short v = (iv == TCharShortMapDecorator.this._map.getNoEntryValue()) ? null : TCharShortMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Character, Short>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TCharShortMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TCharShortMapDecorator.this._map.remove(TCharShortMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TCharShortMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Character, ? extends Short>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Character, ? extends Short> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TCharShortMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TCharShortMapDecorator.class
