...
/*  405 */     return new TIntDoubleHashIterator(this);
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*  527 */       return new TIntDoubleHashMap.TIntDoubleKeyHashIterator((TPrimitiveHash)TIntDoubleHashMap.this);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int getNoEntryValue() {
/*  533 */       return TIntDoubleHashMap.this.no_entry_key;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int size() {
/*  539 */       return TIntDoubleHashMap.this._size;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean isEmpty() {
/*  545 */       return (0 == TIntDoubleHashMap.this._size);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean contains(int entry) {
/*  551 */       return TIntDoubleHashMap.this.contains(entry);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int[] toArray() {
/*  557 */       return TIntDoubleHashMap.this.keys();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int[] toArray(int[] dest) {
/*  563 */       return TIntDoubleHashMap.this.keys(dest);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  579 */       return (TIntDoubleHashMap.this.no_entry_value != TIntDoubleHashMap.this.remove(entry));
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  588 */           if (!TIntDoubleHashMap.this.containsKey(ele))
/*  589 */             return false; 
/*      */           continue;
/*      */         } 
/*  592 */         return false;
...
/*  603 */         if (!TIntDoubleHashMap.this.containsKey(iter.next())) {
/*  604 */           return false;
/*      */         }
/*      */       } 
/*  607 */       return true;
...
/*  614 */         if (!TIntDoubleHashMap.this.contains(element)) {
/*  615 */           return false;
/*      */         }
/*      */       } 
/*  618 */       return true;
...
/*  688 */       int[] set = TIntDoubleHashMap.this._set;
/*  689 */       byte[] states = TIntDoubleHashMap.this._states;
/*      */       
/*  691 */       for (int i = set.length; i-- > 0;) {
/*  692 */         if (states[i] == 1 && Arrays.binarySearch(array, set[i]) < 0) {
/*  693 */           TIntDoubleHashMap.this.removeAt(i);
/*  694 */           changed = true;
/*      */         } 
/*      */       } 
/*  697 */       return changed;
...
/*      */     
/*      */     public void clear() {
/*  748 */       TIntDoubleHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean forEach(TIntProcedure procedure) {
/*  754 */       return TIntDoubleHashMap.this.forEachKey(procedure);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  765 */         return false;
/*      */       }
/*  767 */       for (int i = TIntDoubleHashMap.this._states.length; i-- > 0;) {
/*  768 */         if (TIntDoubleHashMap.this._states[i] == 1 && 
/*  769 */           !that.contains(TIntDoubleHashMap.this._set[i])) {
/*  770 */           return false;
/*      */         }
/*      */       } 
/*      */       
...
/*      */     public int hashCode() {
/*  780 */       int hashcode = 0;
/*  781 */       for (int i = TIntDoubleHashMap.this._states.length; i-- > 0;) {
/*  782 */         if (TIntDoubleHashMap.this._states[i] == 1) {
/*  783 */           hashcode += HashFunctions.hash(TIntDoubleHashMap.this._set[i]);
/*      */         }
/*      */       } 
/*  786 */       return hashcode;
/*      */     }
...
/*  793 */       TIntDoubleHashMap.this.forEachKey(new TIntProcedure()
/*      */           {
...
/*  819 */       return new TIntDoubleHashMap.TIntDoubleValueHashIterator((TPrimitiveHash)TIntDoubleHashMap.this);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double getNoEntryValue() {
/*  825 */       return TIntDoubleHashMap.this.no_entry_value;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public int size() {
/*  831 */       return TIntDoubleHashMap.this._size;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean isEmpty() {
/*  837 */       return (0 == TIntDoubleHashMap.this._size);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean contains(double entry) {
/*  843 */       return TIntDoubleHashMap.this.containsValue(entry);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double[] toArray() {
/*  849 */       return TIntDoubleHashMap.this.values();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public double[] toArray(double[] dest) {
/*  855 */       return TIntDoubleHashMap.this.values(dest);
/*      */     }
/*      */ 
/*      */ 
/*      */     
...
/*  867 */       double[] values = TIntDoubleHashMap.this._values;
/*  868 */       byte[] states = TIntDoubleHashMap.this._states;
/*      */       
/*  870 */       for (int i = values.length; i-- > 0;) {
/*  871 */         if (states[i] != 0 && states[i] != 2 && entry == values[i]) {
/*  872 */           TIntDoubleHashMap.this.removeAt(i);
/*  873 */           return true;
/*      */         } 
/*      */       } 
/*  876 */       return false;
...
/*  884 */           if (!TIntDoubleHashMap.this.containsValue(ele))
/*  885 */             return false; 
/*      */           continue;
/*      */         } 
/*  888 */         return false;
...
/*  899 */         if (!TIntDoubleHashMap.this.containsValue(iter.next())) {
/*  900 */           return false;
/*      */         }
/*      */       } 
/*  903 */       return true;
...
/*  910 */         if (!TIntDoubleHashMap.this.containsValue(element)) {
/*  911 */           return false;
/*      */         }
/*      */       } 
/*  914 */       return true;
...
/*  972 */       double[] values = TIntDoubleHashMap.this._values;
/*  973 */       byte[] states = TIntDoubleHashMap.this._states;
/*      */       
/*  975 */       for (int i = values.length; i-- > 0;) {
/*  976 */         if (states[i] == 1 && Arrays.binarySearch(array, values[i]) < 0) {
/*  977 */           TIntDoubleHashMap.this.removeAt(i);
/*  978 */           changed = true;
/*      */         } 
/*      */       } 
/*  981 */       return changed;
...
/*      */     
/*      */     public void clear() {
/* 1032 */       TIntDoubleHashMap.this.clear();
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public boolean forEach(TDoubleProcedure procedure) {
/* 1038 */       return TIntDoubleHashMap.this.forEachValue(procedure);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1046 */       TIntDoubleHashMap.this.forEachValue(new TDoubleProcedure() {
/*      */             private boolean first = true;
/*      */             
...
/* 1080 */       return TIntDoubleHashMap.this._set[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1092 */         TIntDoubleHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/* 1118 */       return TIntDoubleHashMap.this._values[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public void remove() {
...
/* 1130 */         TIntDoubleHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/*      */     
/*      */     public int key() {
/* 1159 */       return TIntDoubleHashMap.this._set[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double value() {
/* 1164 */       return TIntDoubleHashMap.this._values[this._index];
/*      */     }
/*      */ 
/*      */     
/*      */     public double setValue(double val) {
/* 1169 */       double old = value();
/* 1170 */       TIntDoubleHashMap.this._values[this._index] = val;
/* 1171 */       return old;
/*      */     }
/*      */ 
/*      */     
...
/* 1182 */         TIntDoubleHashMap.this.removeAt(this._index);
/*      */       } finally {
/*      */         
...
/*      */   
/*      */   public boolean equals(Object other) {
/* 1195 */     if (!(other instanceof TIntDoubleMap)) {
/* 1196 */       return false;
/*      */     }
/* 1198 */     TIntDoubleMap that = (TIntDoubleMap)other;
...
/* 1246 */     forEachEntry(new TIntDoubleProcedure()
/*      */         {
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\map\hash\TIntDoubleHashMap.class
