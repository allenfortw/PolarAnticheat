...
/* 192 */     return new AbstractSet<Map.Entry<Byte, Character>>() {
/*     */         public int size() {
/* 194 */           return TByteCharMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TByteCharMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TByteCharMapDecorator.this.containsKey(k) && TByteCharMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Byte, Character>>() {
/* 214 */               private final TByteCharIterator it = TByteCharMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Byte, Character> next() {
/* 217 */                 this.it.advance();
/* 218 */                 byte ik = this.it.key();
/* 219 */                 final Byte key = (ik == TByteCharMapDecorator.this._map.getNoEntryKey()) ? null : TByteCharMapDecorator.this.wrapKey(ik);
/* 220 */                 char iv = this.it.value();
/* 221 */                 final Character v = (iv == TByteCharMapDecorator.this._map.getNoEntryValue()) ? null : TByteCharMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Byte, Character>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TByteCharMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TByteCharMapDecorator.this._map.remove(TByteCharMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TByteCharMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Byte, ? extends Character>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Byte, ? extends Character> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TByteCharMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TByteCharMapDecorator.class
