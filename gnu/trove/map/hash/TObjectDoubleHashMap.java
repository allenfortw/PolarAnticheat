...
/*  141 */       this._loadFactor = Math.abs(hashmap._loadFactor);
...
/*      */       }
/*  147 */       setUp(saturatedCast(fastCeil(10.0D / this._loadFactor)));
/*      */     } 
/*  149 */     putAll(map);
/*      */   }
/*      */ 
...
/*  591 */           if (that.get(key) != that.getNoEntryValue() || 
/*  592 */             !that.containsKey(key))
/*      */           {
/*  594 */             return false; } 
/*      */           continue;
/*      */         } 
...
/*      */       }
/*      */     
/*  602 */     } catch (ClassCastException classCastException) {}
/*      */ 
/*      */     
/*  605 */     return true;
/*      */   }
...
/*      */       {
/*  684 */         a = (T[])Array.newInstance(a
/*  685 */             .getClass().getComponentType(), size);
/*      */       }
/*      */       
...
/*  868 */         if (set[i] != TObjectHash.FREE && set[i] != TObjectHash.REMOVED && 
/*      */           
/*  870 */           Arrays.binarySearch(array, values[i]) < 0) {
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\map\hash\TObjectDoubleHashMap.class
