...
/* 192 */     return new AbstractSet<Map.Entry<Character, Integer>>() {
/*     */         public int size() {
/* 194 */           return TCharIntMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TCharIntMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TCharIntMapDecorator.this.containsKey(k) && TCharIntMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Character, Integer>>() {
/* 214 */               private final TCharIntIterator it = TCharIntMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Character, Integer> next() {
/* 217 */                 this.it.advance();
/* 218 */                 char ik = this.it.key();
/* 219 */                 final Character key = (ik == TCharIntMapDecorator.this._map.getNoEntryKey()) ? null : TCharIntMapDecorator.this.wrapKey(ik);
/* 220 */                 int iv = this.it.value();
/* 221 */                 final Integer v = (iv == TCharIntMapDecorator.this._map.getNoEntryValue()) ? null : TCharIntMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Character, Integer>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TCharIntMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TCharIntMapDecorator.this._map.remove(TCharIntMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TCharIntMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Character, ? extends Integer>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Character, ? extends Integer> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TCharIntMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TCharIntMapDecorator.class
