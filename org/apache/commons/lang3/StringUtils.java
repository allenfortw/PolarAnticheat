...
/*  351 */       throw new IllegalArgumentException(String.format("Minimum abbreviation width is %d", new Object[] { Integer.valueOf(minAbbrevWidth) }));
/*      */     }
...
/*  367 */       throw new IllegalArgumentException(String.format("Minimum abbreviation width with offset is %d", new Object[] { Integer.valueOf(minAbbrevWidthOffset) }));
/*      */     }
...
/*  554 */     int outOffset = 0;
/*  555 */     newCodePoints[outOffset++] = newCodePoint; int inOffset;
/*  556 */     for (inOffset = Character.charCount(firstCodepoint); inOffset < strLen; ) {
...
/* 1169 */     if (isEmpty(cs) || ArrayUtils.isEmpty((Object[])searchCharSequences)) {
/* 1170 */       return false;
/*      */     }
...
/* 1523 */     return isBlank((CharSequence)str) ? defaultStr : str;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1545 */     return isEmpty((CharSequence)str) ? defaultStr : str;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1738 */     if (isEmpty(sequence) || ArrayUtils.isEmpty((Object[])searchStrings)) {
/* 1739 */       return false;
/*      */     }
...
/* 1944 */         if (isNotBlank((CharSequence)val)) {
/* 1945 */           return val;
/*      */         }
/*      */       } 
/*      */     }
...
/* 1979 */         if (isNotEmpty((CharSequence)val)) {
/* 1980 */           return val;
/*      */         }
/*      */       } 
/*      */     }
...
/* 2048 */     if (ArrayUtils.isEmpty((Object[])strs)) {
/* 2049 */       return "";
/*      */     }
/* 2051 */     int smallestIndexOfDiff = indexOfDifference((CharSequence[])strs);
...
/* 2213 */     return isBlank((CharSequence)str) ? ((defaultSupplier == null) ? null : defaultSupplier.get()) : str;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2241 */     return isEmpty((CharSequence)str) ? ((defaultSupplier == null) ? null : defaultSupplier.get()) : str;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 2508 */     Arrays.fill(p, boundary, p.length, 2147483647);
/* 2509 */     Arrays.fill(d, 2147483647);
/*      */ 
/*      */     
...
/*      */ 
/*      */       
/* 2531 */       for (int k = min; k <= max; k++) {
/* 2532 */         if (s.charAt(k - 1) == t_j) {
/*      */           
/* 2534 */           d[k] = p[k - 1];
/*      */         } else {
/*      */           
/* 2537 */           d[k] = 1 + Math.min(Math.min(d[k - 1], p[k]), p[k - 1]);
/*      */         } 
/*      */       } 
/*      */ 
/*      */       
...
/* 2897 */       int j = 0; while (true) { if (j < searchLen) {
...
/*      */     }
/*      */     int i;
/* 3079 */     for (i = 0; i < cs1.length() && i < cs2.length() && 
/* 3080 */       cs1.charAt(i) == cs2.charAt(i); i++);
/*      */ 
/*      */ 
/*      */     
...
/* 3195 */     if (ArrayUtils.isEmpty((Object[])css)) {
/* 3196 */       return true;
/*      */     }
...
/* 3226 */     if (ArrayUtils.isEmpty((Object[])css)) {
/* 3227 */       return true;
/*      */     }
...
/* 3471 */     if (ArrayUtils.isEmpty((Object[])css)) {
/* 3472 */       return false;
/*      */     }
...
/* 3503 */     if (ArrayUtils.isEmpty((Object[])css)) {
/* 3504 */       return false;
/*      */     }
...
/* 4855 */     return join((Object[])elements, (String)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 5450 */     char[] ms2 = new char[matches]; int i, si;
/* 5451 */     for (i = 0, si = 0; i < min.length(); i++) {
/* 5452 */       if (matchIndexes[i] != -1) {
/* 5453 */         ms1[si] = min.charAt(i);
/* 5454 */         si++;
/*      */       } 
/*      */     } 
/* 5457 */     for (i = 0, si = 0; i < max.length(); i++) {
...
/* 5464 */     for (int j = 0; j < ms1.length; j++) {
/* 5465 */       if (ms1[j] != ms2[j]) {
/* 5466 */         transpositions++;
/*      */       }
/*      */     } 
/* 5469 */     int prefix = 0;
/* 5470 */     for (int k = 0; k < min.length() && 
/* 5471 */       first.charAt(k) == second.charAt(k); k++) {
/* 5472 */       prefix++;
/*      */     }
/*      */ 
/*      */ 
...
/* 5587 */         newChars[count++] = (actualChar == ' ') ? ' ' : actualChar;
...
/*      */       case 2:
/* 6293 */         ch0 = str.charAt(0);
/* 6294 */         ch1 = str.charAt(1);
/* 6295 */         output2 = new char[outputLength];
/* 6296 */         for (i = repeat * 2 - 2; i >= 0; i--, i--) {
/* 6297 */           output2[i] = ch0;
...
/*      */ 
/*      */     
/* 6714 */     if (isEmpty(text) || ArrayUtils.isEmpty((Object[])searchList) || ArrayUtils.isEmpty((Object[])replacementList) || (ArrayUtils.isNotEmpty(searchList) && timeToLive == -1)) {
/* 6715 */       return text;
/*      */     }
/*      */     
...
/*      */ 
/*      */     
/* 6766 */     for (int j = 0; j < searchList.length; j++) {
/* 6767 */       if (searchList[j] != null && replacementList[j] != null) {
/*      */ 
/*      */         
/* 6770 */         int greater = replacementList[j].length() - searchList[j].length();
/* 6771 */         if (greater > 0) {
...
/*      */       int m;
/* 6782 */       for (m = start; m < textIndex; m++) {
/* 6783 */         buf.append(text.charAt(m));
/*      */       }
...
/*      */ 
/*      */       
/* 6793 */       for (m = 0; m < searchLength; m++) {
/* 6794 */         if (!noMoreMatchesForReplIndex[m] && searchList[m] != null && 
/* 6795 */           !searchList[m].isEmpty() && replacementList[m] != null) {
/*      */ 
/*      */           
/* 6798 */           tempIndex = text.indexOf(searchList[m], start);
/*      */ 
/*      */           
/* 6801 */           if (tempIndex == -1) {
/* 6802 */             noMoreMatchesForReplIndex[m] = true;
...
/* 6812 */     for (int k = start; k < textLength; k++) {
/* 6813 */       buf.append(text.charAt(k));
/*      */     }
...
/* 7510 */     return list.<String>toArray(ArrayUtils.EMPTY_STRING_ARRAY);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 7738 */     return substrings.<String>toArray(ArrayUtils.EMPTY_STRING_ARRAY);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     }
/* 7926 */     return list.<String>toArray(ArrayUtils.EMPTY_STRING_ARRAY);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     }
/* 8026 */     return list.<String>toArray(ArrayUtils.EMPTY_STRING_ARRAY);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 8101 */     if (isEmpty(sequence) || ArrayUtils.isEmpty((Object[])searchStrings)) {
/* 8102 */       return false;
/*      */     }
...
/* 8215 */       return null;
/*      */     }
/* 8217 */     StringBuilder decomposed = new StringBuilder(Normalizer.normalize(input, Normalizer.Form.NFD));
...
/* 8930 */       return null;
/*      */     }
/* 8932 */     return list.<String>toArray(ArrayUtils.EMPTY_STRING_ARRAY);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 8969 */     int outOffset = 0; int i;
/* 8970 */     for (i = 0; i < strLen; ) {
/* 8971 */       int newCodePoint, oldCodepoint = str.codePointAt(i);
/*      */       
...
/* 9314 */     newCodePoints[outOffset++] = newCodePoint; int inOffset;
/* 9315 */     for (inOffset = Character.charCount(firstCodepoint); inOffset < strLen; ) {
...
/* 9350 */     if (isEmpty(str) || wrapChar == '\000' || str.length() == 1) {
/* 9351 */       return str;
/*      */     }
/*      */     
...
/* 9493 */     if (isEmpty(str) || wrapWith == '\000') {
/* 9494 */       return str;
/*      */     }
/*      */     
...
/* 9566 */     if (isEmpty(str) || wrapWith == '\000') {
/* 9567 */       return str;
/*      */     }
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\org\apache\commons\lang3\StringUtils.class
