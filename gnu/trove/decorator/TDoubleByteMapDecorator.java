...
/* 192 */     return new AbstractSet<Map.Entry<Double, Byte>>() {
/*     */         public int size() {
/* 194 */           return TDoubleByteMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TDoubleByteMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TDoubleByteMapDecorator.this.containsKey(k) && TDoubleByteMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Double, Byte>>() {
/* 214 */               private final TDoubleByteIterator it = TDoubleByteMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Double, Byte> next() {
/* 217 */                 this.it.advance();
/* 218 */                 double ik = this.it.key();
/* 219 */                 final Double key = (ik == TDoubleByteMapDecorator.this._map.getNoEntryKey()) ? null : TDoubleByteMapDecorator.this.wrapKey(ik);
/* 220 */                 byte iv = this.it.value();
/* 221 */                 final Byte v = (iv == TDoubleByteMapDecorator.this._map.getNoEntryValue()) ? null : TDoubleByteMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Double, Byte>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TDoubleByteMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TDoubleByteMapDecorator.this._map.remove(TDoubleByteMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TDoubleByteMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Double, ? extends Byte>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Double, ? extends Byte> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TDoubleByteMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TDoubleByteMapDecorator.class
