...
/* 192 */     return new AbstractSet<Map.Entry<Character, Byte>>() {
/*     */         public int size() {
/* 194 */           return TCharByteMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TCharByteMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TCharByteMapDecorator.this.containsKey(k) && TCharByteMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Character, Byte>>() {
/* 214 */               private final TCharByteIterator it = TCharByteMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Character, Byte> next() {
/* 217 */                 this.it.advance();
/* 218 */                 char ik = this.it.key();
/* 219 */                 final Character key = (ik == TCharByteMapDecorator.this._map.getNoEntryKey()) ? null : TCharByteMapDecorator.this.wrapKey(ik);
/* 220 */                 byte iv = this.it.value();
/* 221 */                 final Byte v = (iv == TCharByteMapDecorator.this._map.getNoEntryValue()) ? null : TCharByteMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Character, Byte>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TCharByteMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TCharByteMapDecorator.this._map.remove(TCharByteMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TCharByteMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Character, ? extends Byte>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Character, ? extends Byte> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TCharByteMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TCharByteMapDecorator.class
