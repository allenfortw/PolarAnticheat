...
/* 192 */     return new AbstractSet<Map.Entry<Integer, Integer>>() {
/*     */         public int size() {
/* 194 */           return TIntIntMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TIntIntMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TIntIntMapDecorator.this.containsKey(k) && TIntIntMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Integer, Integer>>() {
/* 214 */               private final TIntIntIterator it = TIntIntMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Integer, Integer> next() {
/* 217 */                 this.it.advance();
/* 218 */                 int ik = this.it.key();
/* 219 */                 final Integer key = (ik == TIntIntMapDecorator.this._map.getNoEntryKey()) ? null : TIntIntMapDecorator.this.wrapKey(ik);
/* 220 */                 int iv = this.it.value();
/* 221 */                 final Integer v = (iv == TIntIntMapDecorator.this._map.getNoEntryValue()) ? null : TIntIntMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Integer, Integer>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TIntIntMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TIntIntMapDecorator.this._map.remove(TIntIntMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TIntIntMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Integer, ? extends Integer>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Integer, ? extends Integer> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TIntIntMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TIntIntMapDecorator.class
