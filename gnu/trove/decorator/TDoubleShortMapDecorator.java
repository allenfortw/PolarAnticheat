...
/* 192 */     return new AbstractSet<Map.Entry<Double, Short>>() {
/*     */         public int size() {
/* 194 */           return TDoubleShortMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TDoubleShortMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TDoubleShortMapDecorator.this.containsKey(k) && TDoubleShortMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Double, Short>>() {
/* 214 */               private final TDoubleShortIterator it = TDoubleShortMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Double, Short> next() {
/* 217 */                 this.it.advance();
/* 218 */                 double ik = this.it.key();
/* 219 */                 final Double key = (ik == TDoubleShortMapDecorator.this._map.getNoEntryKey()) ? null : TDoubleShortMapDecorator.this.wrapKey(ik);
/* 220 */                 short iv = this.it.value();
/* 221 */                 final Short v = (iv == TDoubleShortMapDecorator.this._map.getNoEntryValue()) ? null : TDoubleShortMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Double, Short>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TDoubleShortMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TDoubleShortMapDecorator.this._map.remove(TDoubleShortMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TDoubleShortMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Double, ? extends Short>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Double, ? extends Short> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TDoubleShortMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TDoubleShortMapDecorator.class
