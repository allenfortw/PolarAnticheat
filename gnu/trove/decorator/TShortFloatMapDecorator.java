...
/* 192 */     return new AbstractSet<Map.Entry<Short, Float>>() {
/*     */         public int size() {
/* 194 */           return TShortFloatMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TShortFloatMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TShortFloatMapDecorator.this.containsKey(k) && TShortFloatMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Short, Float>>() {
/* 214 */               private final TShortFloatIterator it = TShortFloatMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Short, Float> next() {
/* 217 */                 this.it.advance();
/* 218 */                 short ik = this.it.key();
/* 219 */                 final Short key = (ik == TShortFloatMapDecorator.this._map.getNoEntryKey()) ? null : TShortFloatMapDecorator.this.wrapKey(ik);
/* 220 */                 float iv = this.it.value();
/* 221 */                 final Float v = (iv == TShortFloatMapDecorator.this._map.getNoEntryValue()) ? null : TShortFloatMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Short, Float>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TShortFloatMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TShortFloatMapDecorator.this._map.remove(TShortFloatMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TShortFloatMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Short, ? extends Float>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Short, ? extends Float> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TShortFloatMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TShortFloatMapDecorator.class
