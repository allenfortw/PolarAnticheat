...
/* 192 */     return new AbstractSet<Map.Entry<Short, Byte>>() {
/*     */         public int size() {
/* 194 */           return TShortByteMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TShortByteMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TShortByteMapDecorator.this.containsKey(k) && TShortByteMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Short, Byte>>() {
/* 214 */               private final TShortByteIterator it = TShortByteMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Short, Byte> next() {
/* 217 */                 this.it.advance();
/* 218 */                 short ik = this.it.key();
/* 219 */                 final Short key = (ik == TShortByteMapDecorator.this._map.getNoEntryKey()) ? null : TShortByteMapDecorator.this.wrapKey(ik);
/* 220 */                 byte iv = this.it.value();
/* 221 */                 final Byte v = (iv == TShortByteMapDecorator.this._map.getNoEntryValue()) ? null : TShortByteMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Short, Byte>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TShortByteMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TShortByteMapDecorator.this._map.remove(TShortByteMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TShortByteMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Short, ? extends Byte>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Short, ? extends Byte> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TShortByteMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TShortByteMapDecorator.class
