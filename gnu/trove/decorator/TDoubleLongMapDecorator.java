...
/* 192 */     return new AbstractSet<Map.Entry<Double, Long>>() {
/*     */         public int size() {
/* 194 */           return TDoubleLongMapDecorator.this._map.size();
/*     */         }
/*     */         
/*     */         public boolean isEmpty() {
/* 198 */           return TDoubleLongMapDecorator.this.isEmpty();
/*     */         }
/*     */         
...
/* 205 */             return (TDoubleLongMapDecorator.this.containsKey(k) && TDoubleLongMapDecorator.this
/* 206 */               .get(k).equals(v));
/*     */           } 
/* 208 */           return false;
/*     */         }
...
/* 213 */           return new Iterator<Map.Entry<Double, Long>>() {
/* 214 */               private final TDoubleLongIterator it = TDoubleLongMapDecorator.this._map.iterator();
/*     */               
/*     */               public Map.Entry<Double, Long> next() {
/* 217 */                 this.it.advance();
/* 218 */                 double ik = this.it.key();
/* 219 */                 final Double key = (ik == TDoubleLongMapDecorator.this._map.getNoEntryKey()) ? null : TDoubleLongMapDecorator.this.wrapKey(ik);
/* 220 */                 long iv = this.it.value();
/* 221 */                 final Long v = (iv == TDoubleLongMapDecorator.this._map.getNoEntryValue()) ? null : TDoubleLongMapDecorator.this.wrapValue(iv);
/* 222 */                 return new Map.Entry<Double, Long>() {
...
/* 244 */                       this.val = value;
/* 245 */                       return TDoubleLongMapDecorator.this.put(key, value);
/*     */                     }
/*     */                   };
/*     */               }
/*     */               
...
/* 269 */             TDoubleLongMapDecorator.this._map.remove(TDoubleLongMapDecorator.this.unwrapKey(key));
/* 270 */             modified = true;
/*     */           } 
/* 272 */           return modified;
/*     */         }
...
/*     */         
/*     */         public void clear() {
/* 280 */           TDoubleLongMapDecorator.this.clear();
/*     */         }
/*     */       };
/*     */   }
/*     */ 
...
/* 338 */     Iterator<? extends Map.Entry<? extends Double, ? extends Long>> it = map.entrySet().iterator();
/* 339 */     for (int i = map.size(); i-- > 0; ) {
/* 340 */       Map.Entry<? extends Double, ? extends Long> e = it.next();
...
/*     */ 
/*     */     
/* 398 */     this._map = (TDoubleLongMap)in.readObject();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\gnu\trove\decorator\TDoubleLongMapDecorator.class
