...
/*    */ 
/*    */ @MessageIdentifier(legacyId = 26)
/*    */ public class MessageUserDataRequest extends Message {
/*    */   private UUID user;
/*    */   private String server;
/*    */   private JsonElement data;
/*    */   
/*    */   public MessageUserDataRequest(UUID user, String server, JsonElement data) {
/* 16 */     this.user = user; this.server = server; this.data = data;
/*    */   }
/*    */   public MessageUserDataRequest() {}
...
/* Location:              D:\Minecraft 伺服器資料\Pika&Jartex\PolarCommon-1.3.5-20230128.224209-66-LEAKED.jar!\net\craftigames\polar\common\messages\collection\server\MessageUserDataRequest.class
